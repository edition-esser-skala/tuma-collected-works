...
G-XVIIITenore = {
  \relative c' {
    ...
    r cis8 cis dis dis dis dis
    dis4( e) dis dis
    dis8.dis16 dis4 r\fermata dis
    dis e dis2 %130
    e4 e e e
    d!2( cis)
    dis4 dis e2 \noBreak
    ...
    d4 r r2
    R1*4 %187
    r4 \mvTr h8\fE^\tutti h h4 h8 a
    g([ a)] h h g4 a
    a g e'4. e8 %190
    d4 d d2
    d1\fermata \bar "|." %192 finis
  }
}

G-XVIIITenoreLyrics = \lyricmode {
  Ky -- ri --
  e e -- lei -- son,
  Chri -- ste e --
  lei -- son, Ky --
