...
H-IILectioPrimaTenore = {
  \relative c' {
    \clef "treble_8"
    \key g \minor \time 4/4 \tempoH-IILectioPrima \autoBeamOff
    R1*3
    r2 \mvTr d4.\pE^\solo es8
    c4 c c8. c16 b8 a %5
    b8. b16 b8 r r4 d8 g,
    es'4 es r8 c d es
    a,2\trill g4 r
    r d'8 d cis4 cis
    r8 cis h a d4 d8 e %10
    f4 f8 r r a, a a
    f f a a d4 d8 g,
    a4 a8 r r4 cis8 cis16 cis
    d4 d8 a b8. b16 b8 \tempoH-IILectioPrimaB d
    es d16 c d8 b c b16 a b8 es %15
    a,2 g4 r
    r2 r4 \tempoH-IILectioPrimaC g8. g16
    c8. g16 e8 g g c, r4
    g'8 as b c as4 r8 c
    f8. f,16 f4 r8 b b f %20
    g4 g8 r r2
    ...
    d4 es! g,2~ %30
    g g4 r
    r \mvTr g8\pE^\solo g c4 c
    r8 es f c d4 d
    r8 f, b c16 d d8 g, r c
    c8. c16 c8 g a a r4 %35
    a8 a d h gis8. gis16 gis4
    g2 f~
    \once \tieDashed f~ f4. f8
    e2~\p e4\fermata r8 cis'16 e
    d8 d d a b8. b16 b4 %40
    r f'8. d16 d8 a r4 \noBreak
    R1\fermata \bar "||"
    ...
    a1 \noBreak
    g\fermata \bar "||" %65
    \tempoH-IIResponsoriumPrimumC r4 \mvTr b8\pE^\solo b b4 a \noBreak
    b b8 b f f f f
    g4. g8 f f f g16 a
    b4. a8 g4. g8 \noBreak
    a4. a8 d,2\fermata \bar "||" %70
...
H-IILectioPrimaTenoreLyrics = \lyricmode {
  Par -- ce %4
  mi -- hi, par -- ce mi -- hi %5
  Do -- mi -- ne: ni -- hil
  e -- nim sunt di -- es
  me -- i.
  Quid est ho -- mo,
  qui -- a ma -- gni -- fi -- cas %10
  e -- um, aut quid op --
  po -- nis er -- ga e -- um cor
  tu -- um, vi -- si -- tas
  e -- um di -- lu -- co -- lo, et
  su -- bi -- to pro -- bas, su -- bi -- to pro -- bas %15
  il -- lum?
  Us -- que --
  quo non par -- cis mi -- hi?
  Nec di -- mit -- tis me, ut
  glu -- ti -- am sa -- li -- vam %20
  me -- am?
  Pec --
  ca -- _ _
  _ vi? Quid
  ...
  cu -- stos ho -- mi -- num?
  Con -- tra -- ri -- um ti -- bi,
  con -- tra -- ri -- um ti -- bi, et
  fa -- ctus sum mi -- hi -- met
  i -- psi gra -- %30
  vis?
  Cur non tol -- lis
  pec -- ca -- tum me -- um,
  et qua -- re non auf -- fers in --
  i -- qui -- ta -- tem me -- am? %35
  Ec -- ce nunc in pul -- ve -- re
  dor -- _
  mi --
  am; __ et si
  ma -- ne me quae -- si -- e -- ris, %40
  non sub -- si -- stam.
...
H-IILectioSecundaTenore = {
  \relative c' {
    \clef "treble_8"
    \key c \dorian \time 4/4 \autoBeamOff \tempoH-IILectioSecunda
    R1*14 %14
    r4 \mvTr as8\fE^\tutti as b4 c8 c %15
    f,2 g4 r
    r e'8 e16 e f8 f d!4
    r d8 d d4 es
    d4. d8 c4 r
    R1*7 %26
    r4 \mvTr a8\fE^\tuttiE a b8. b16 b4
    ...
    \tempoH-IIResponsoriumSecundumD
      r4 \mvTr as8\pE^\solo as es'8. es16 es4 \noBreak %70
    e8 e e8. e16 f8 f, r f
    des'4. des8 c4 r8 c
    f8. f16 d8 es! b2 \noBreak
    es,1\fermata \bar "||"
    \tempoH-IIResponsoriumSecundumC R1 \noBreak %75
    \mvTr c'2\fE^\tutti es4 h
    c es d4. d8
    g,4 h c4 b
    c4. des8 b4( c
    as) g8([ f)] g2 %80
...
H-IILectioSecundaTenoreLyrics = \lyricmode {
  No -- li me con -- dem -- %15
  na -- re,
  in -- di -- ca mi -- hi cur?
  cur me i -- ta
  ...
  Nun -- quid o -- cu -- li %27
  car -- ne -- i ti -- bi sunt, aut
  si -- cut vi -- det ho -- mo, si -- cut
  ho -- mo et tu vi -- %30
  de -- bis?
...
H-IILectioTertiaTenoreLyrics = \lyricmode {
  Ma -- nus %4
  tu -- ae fe -- %5
