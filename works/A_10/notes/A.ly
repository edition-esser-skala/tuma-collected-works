...
A-XIIKyrieAlto = {
  \relative c' {
    \clef treble
    \key e \minor \time 4/4 \tempoA-XKyrie \autoBeamOff
    e4^\tutti e fis g8([ a)]
    g e h'2 ais4
    h g fis2
    e fis
...
A-XIIGloriaAlto = {
  \relative c' {
    \clef treble
    \key e \minor \time 4/4 \autoBeamOff \tempoA-XGloria
    R1
    e4^\tuttiE e8 e fis a16 a a8 gis
...
A-XIICredoAlto = {
  \relative c' {
    \clef treble
    \key e \minor \time 4/4 \autoBeamOff \tempoA-XCredo
    r2 e8^\tuttiE dis e e16 e
    ...
    r r8 fis d4 d8 e
    d2 d4 \tempoA-XEtIncarnatus r
    gis4 gis8 e e8. e16 e4 %10
    r2 f8 f e e
    e8. e16 e8 a gis gis g g
    f f g g g a g8. g16
    \tempoA-XEtResurrexit g4 r g8 g g g16 g
...
A-XIICredoAltoLyrics = \lyricmode {
  ...
  coe -- lum, se -- det ad dex -- te -- ram Pa -- tris, %15
  vi -- vos et
  mor -- tu -- os,
  ...
  a -- men, a -- men. %23 finis
}

A-XIISanctusAlto = {
  \relative c' {
    \clef treble
    \key e \minor \time 3/2 \autoBeamOff \tempoA-XSanctus
    r4 g'^\tuttiE e fis g a
    g fis e fis g a
    g2 g r
    r4 fis d e fis g
    fis e d e fis g %5
...
A-XIIBenedictusAlto = {
  \relative c' {
    \clef treble
    \key e \minor \time 3/2 \autoBeamOff \tempoA-XBenedictus
    R1.*2
    r2 e^\aTre e
    g fis e
    d4( cis) h2 h' %5
...
A-XIIAgnusAlto = {
  \relative c' {
    \clef treble
    \key e \minor \time 4/4 \autoBeamOff \tempoA-XAgnus
    e4^\tuttiE e fis fis8 fis
    g g fis4 g( fis8) e
