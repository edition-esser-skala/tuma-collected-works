...
A-XXXVKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e, %2
  Ky -- ri -- e, Ky -- ri -- e e --
  lei -- son, e -- lei --
  son, e -- lei -- %5
...
A-XXXVGloriaBassoLyrics = \lyricmode {
  Et in ter -- ra
  pax ho -- mi -- ni -- bus
  bo -- nae, bo -- nae
  vo -- lun -- ta -- tis. Lau --
...
A-XXXVCredoBasso = {
  \relative c {
    ...
    e,4 e'8 d cis4 d8 d
    g e a4 d,4. h8
    c! a d4 \after 8 \tempoA-XXXVCredoAmen g, r
...
A-XXXVCredoBassoLyrics = \lyricmode {
  Cre -- do in De -- um Pa --
  trem o -- mni -- po -- ten --
...
A-XXXVSanctusBassoLyrics = \lyricmode {
  San --
  ctus,
  san -- ctus,
  san --
...
A-XXXVBenedictusBassoLyrics = \lyricmode {
  O -- san -- na in ex -- %37
  cel -- sis,
  in ex --
...
A-XXXVAgnusBasso = {
  \relative c {
    ...
    e d! c2 \noBreak
    h1\fermata \bar "||"
    \key e \minor \tempoA-XXXVDona R1*3 %21
    \mvTr h'2.\fE^\tutti a4~
    a g2 fis4
    g2( a4) h
    gis a dis, e8[ d?] %25
...
A-XXXVAgnusBassoLyrics = \lyricmode {
  A -- gnus De -- i, qui %7
  tol -- lis
  pec -- ca -- ta
  mun -- di: %10
