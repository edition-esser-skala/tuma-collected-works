...
A-XXXVKyrieOrgano = {
  \relative c {
    ...
    a g c2 \noBreak
    h1\fermata \bar "||"
    \clef treble \time 6/4 \tempoA-XXXVKyrieB \newSpacingSection
    << {
      e''2.~ e4 dis h \noBreak
      d2.~ d4 cis a %15
      c2. h
...
A-XXXVKyrieBassFigures = \figuremode {
  r2 <6 4>
  <6 5>1
  r2 <7>
  r4. <6>8 <7 _+>4 <6>8 <5>
...
A-XXXVGloriaOrgano = {
  \relative c {
    ...
    e e d h c2
    h4 \clef treble \tempoA-XXXVAmen r8 e' dis4 e8 fis
    << {
      r2 r4 h
...
A-XXXVGloriaBassFigures = \figuremode {
  r2 <5 4>8 <\t _+>4.
  <6 5>2 <9 4>4 <8 3>
  \bo <[6]>2. <6>4
  <9>8 \bc <[5]> <6 5>2.
...
A-XXXVCredoOrgano = {
  \relative c {
    ...
    e, e'8 d cis4 d8 d
    g e a a, d4. h8
    c! a d d, g \clef treble \tempoA-XXXVCredoAmen g''16[-! a]-! h8-! h16-! c-!
...
A-XXXVCredoBassFigures = \figuremode {
...
A-XXXVSanctusBassFigures = \figuremode {
  r1
  <4>4 <_+> <6 5>2
  r <9 4>4 <8 3>
  r1
...
A-XXXVBenedictusBassFigures = \figuremode {
  r4 <6>2 q4
  r \bo <[6]> r4. \bc q8
  <6\\> <\t> <5> <6> <6 _->2
  r <_!>4 \bo <[6 _]>
...
A-XXXVAgnusOrgano = {
  \relative c {
    ...
    e4 d! c2 \noBreak
    h1\fermata \bar "||"
    \clef treble \key e \minor \tempoA-XXXVDona
...
A-XXXVAgnusBassFigures = \figuremode {
  r2 <7>8 <6>4 <5>8
  <4>4 <3>2.
  r2 <4\+ 2>
  <6\\> <4>4 <3>
