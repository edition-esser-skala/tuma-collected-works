...
E-IV-IIViolinoI = {
  \relative c' {
    ...
    c d h4.\trill a8 \noBreak
    a4 r r\fermata \bar "||"
    \time 4/4 \tempoE-IV-IIAdTe r2 r8 h'\f h h \noBreak
    h2 h
    r r8 d! d d %60
    cis2. h4~
    h ais a a8 a
    ...
    R1 \noBreak %80
    R\fermata \bar "||"
    \tempoE-IV-IIEia r4 g8 c, \appoggiatura c16 h8 c d e16 f \noBreak
    ...
    c4. h8 c4. h8 \bar "|"
    \time 3/4 \tempoE-IV-IIEtIesum c4 r r \noBreak
    R2.*35 \bar "|" %153
    \time 4/4 \tempoE-IV-IIOClemens R1*4 %157
    r4 e\fE f8 e dis4
    e8 d cis4 d8 c h4
    a r e' e16 f e f %160
