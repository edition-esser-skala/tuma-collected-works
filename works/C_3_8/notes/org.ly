...
C-III-VIIIOrgano = {
  \relative c {
    ...
    his1
    h2 ais4 r \noBreak %15
    r \mvDl h-!\fE e,-! r\fermata \bar "||"
    \twofourtime \key a \minor \time 2/4 \tempoC-III-VIIIOter \newSpacingSection
      a8\fE a a a \noBreak
    a a a a
    e' e a a
    a a a a %20
    ...
    a4 r
    r8 a,\pE a a \noBreak
    e'4 r \markCritnote \bar "S-S"
    \key a \minor \time 4/4 \tempoC-III-VIIIInter \newSpacingSection
      g1~\pE \noBreak %195
    g
    ais,~
    ais2 a~
    ...
    \key e \minor \tempoC-III-VIIIOvera
      \set Score.currentBarNumber = #212
      \partial 8 r8 \noBreak e\fE fis g a h a g e \noBreak
    fis e dis h e e g e
    h' h, cis dis e fis gis a %215
    h4 r8 e, a a, c a
    d e fis g a4 r8 d,
    g, g'16 a h8 g a g a g
    a g a g16 a h8 a g e
    fis e dis h e g a h %220
    gis4 a g8 a h h,
    e4 r r8 e\pE g e
    r h dis h cis4 dis8 h
    e d c h a c d d,
    g g' fis d g g, h g %225
    c a d d, g\fE g'16 a h( g) g-! h-!
    c8 a16 h cis( a) a-! cis-! d8 d,16 e fis( d) d-! fis-!
    g8 e c d g,4 r
    r8 g'\pE h g r d h g
    c4 r8 d g,4 r8 g' %230
    cis, cis dis dis e4 r8 e
    a, a h h c4 r8 h
    a a' gis e a4 r8 d,
    g, g' fis d g4 r8 e
    a, h c a h4 \clef "treble_8" r8 dis' %235
    ...
    h1~
    h2 e,4 r
    e'8\fE fis gis a h4 r8 e,
    a a, c a d e fis g
    a4 r8 d, g, g'16 a h8 g %245
    a g a a h a g e
    fis e dis h e g a h
    e,4\fermata r8 h\pE c h r g
    d' d c c h h h h
    c4 r8 c cis cis cis cis %250
    d d, d'4 r d8 d
    ...
    cis8 e cis h ais2
    h4 r fis'2
    h,4 r r2 \markDaCapo \bar "||" %260 finis
  }
}

C-III-VIIIBassFigures = \figuremode {
  r1
  r
  <6\\>2 <6 5 _+>
  <7 \t \t>4 <6 \t \t>2.
  ...
  <\t>4 <6\\> <5\+ _+>2
  <6 5!>2 <6 5>
  <5>4. \once \bassFigureExtendersOn q8 <7>8 <6>4 <5>8
  r2 <5\+ 4>4 <\t _+>
  r1 %260 finis
}
