...
F-IIStabatAlto = {
  \relative c' {
    ...
    g2 fis4 r\fermata
    \tempoF-IIPerTransivit g8 g a a g8. g16 g4
...
F-IIStabatAltoLyrics = \lyricmode {
  Sta --
  bat ma --
  ter do --
  lo -- ro -- _
...
F-IIQuisEstAltoLyrics = \lyricmode {
...
F-IIProPeccatisAlto = {
  \relative c' {
    ...
    \tempoF-IIViditSuum e4. e8 f4 f
    r2 f4 g8([ as)] %20
    b4 as8([ g)] g f r4
    r2 as4\p as
    g g g g
    g(\crescE f) g2
    \tempoF-IIDumEmisit r4 g8\fE g g g r4 %25
    r g8 g as as r4
    \tempoF-IISpiritum es8\p r d r c r r4\fermata \bar "||" %27 finis
  }
}

F-IIProPeccatisAltoLyrics = \lyricmode {
  Pro pec -- %5
...
F-IIEiaMaterAltoLyrics = \lyricmode {
  E -- ia,
  ma -- ter,
  fons a --
  mo -- ris,
...
F-IISanctaMaterAltoLyrics = \lyricmode {
  San -- cta ma -- ter,
  san -- cta ma -- ter,
  i -- stud, i -- stud
  a -- gas, cru -- ci --
...
F-IIChristeAltoLyrics = \lyricmode {
  Chri -- ste,
