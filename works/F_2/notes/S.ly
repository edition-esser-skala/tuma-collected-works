...
F-IIStabatSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoF-IIStabat
    \mvDll d'2~_\fE d4 b
    g g r es'~
    es d2 c4~
    c h c c~
    ...
    d c4 b8[ a] b4~
    b2 a4 r\fermata
    \tempoF-IIPerTransivit b8 d c b16([ a)] b[ g a b] c[ d e fis]
    g8. g,16 g4 r2 %30
...
F-IIStabatSopranoLyrics = \lyricmode {
  Sta -- bat
  ma -- ter do --
  lo -- ro --
  _ sa, do --
...
F-IIOQuamSoprano = {
  \relative c' {
    \clef treble
    \key d \phrygian \time 3/4 \autoBeamOff \tempoF-IIOQuam
    R2.
    r4 b'\fE b
    b8([ a)] a4 r
    r es'! d
...
F-IIOQuamSopranoLyrics = \lyricmode {
  Et af -- %2
  fli -- cta
  be -- ne --
  di -- cta %5
...
F-IIQuisEstSoprano = {
  \relative c' {
    \clef treble
    \key d \phrygian \time 4/4 \autoBeamOff \tempoF-IIQuisEst
    r2 r4 a'8\fE cis
    d d, d' d d([ cis)] r4
    c8([ h)] r4 b8([ a)] r4
...
F-IIQuisEstSopranoLyrics = \lyricmode {
  Quis est
  ho -- mo, qui non fle --
  _ _
  _ _ ret, ma -- trem
...
F-IIProPeccatisSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoF-IIProPeccatis
    R1*6 %6
    d'4.\fE g,8 b h r h
    c cis r cis d c16([ b)] a([ g)] f([ e)]
    f([ e)] d8 a' a g[ c c, b']
    a[ d d, c'] b4 b8 b %10
    b2 a4 \tempoF-IIViditIesum r
    ...
    d d, r h' c4 es,
    d4. d8 c4 r\fermata
    \tempoF-IIViditSuum c'4. c8 c8([ b)] b4
    b8([ c)] c([ des)] \once \tieDashed des2~ %20
    des4 c8[ b] as4 r
    c\p c c2
    h c4 c
    c2\cresc h
    \tempoF-IIDumEmisit r4 h8\f h c16([ d)] es8 r4
    r c8 c c16([ b)] c8 r4
    \tempoF-IISpiritum g8\p r g r g r r4\fermata \bar "||"
  }
}

F-IIProPeccatisSopranoLyrics = \lyricmode {
...
F-IIEiaMaterSoprano = {
  \relative c' {
    \clef treble
    \key es \lydian \time 3/4 \autoBeamOff \tempoF-IIEiaMater
    r4 es'\fE b
    c b es~
    es d8[ c] b([ as)]
    as4 g es'~
...
F-IIEiaMaterSopranoLyrics = \lyricmode {
  E -- ia,
  ma -- ter, fons __
  _ a --
  mo -- ris, fons __
...
F-IISanctaMaterSoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \autoBeamOff \tempoF-IISanctaMater
...
F-IISanctaMaterSopranoLyrics = \lyricmode {
  San -- cta ma -- ter,
  san -- cta ma -- ter,
  i -- stud a -- gas, i -- stud
  a -- gas, cru -- ci --
...
F-IIFacMeSoprano = {
  \relative c' {
    \clef treble
    \key f \dorian \time 3/2 \autoBeamOff \tempoF-IIFacMe
    f2\fE as( b)
    c1 b2
    as1.
    g
...
F-IIFacMeSopranoLyrics = \lyricmode {
  Fac me, __
  fac me
  te --
  cum
...
F-IIVirgoSoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \autoBeamOff \tempoF-IIVirgo
    R1*7 %7
    b'4\fE es es d
    c f f es
    d4. d8 es2~ %10
...
F-IIVirgoSopranoLyrics = \lyricmode {
  Fac, ut por -- tem %8
  Chri -- sti mor -- tem,
  pas -- si -- o -- %10
  nis __ fac con --
...
F-IIChristeSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoF-IIChriste
    r2 f'4\fE c
    es8 es f c d4 d
    b4. b8 as2
    g4 c8 b b4 a8 c
    ...
    \tempoF-IIFacUt g4\fE g b4. a16([ g)]
    c4 es fis,2
    g8 a b([ c] d) a d4~ %15
    ...
    fis a( b[ a16 g] a4.) a8
    g4 r \tempoF-IIAmen r d'~ %65
    d c8[ h] c2~
    c4 h8[ a] h2\fermata \bar "|." %67 FINIS
  }
}

F-IIChristeSopranoLyrics = \lyricmode {
  Chri -- ste,
