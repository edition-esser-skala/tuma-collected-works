...
A-XXVIIKyrieOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIKyrie
    ...
    r8 b b b a2 \noBreak
    d1\fermata \bar "||"
    \tempoA-XXVIIKyrieB g,4 r g'4. g8 \noBreak %10
    ...
    g4 r8 a d, \brkBeam \clef "treble_8" a'-\tutti d4~
    d cis4~ cis8 fis, h4~
    h a4~ a8 d, g4~
    g8 \brkBeam \clef bass d g2 fis4~
    fis8 h, e2 d4~ %40
    d8 g, c4 h8 e h4
...
A-XXVIIKyrieBassFigures = \figuremode {
  r2 <6>
  r <4 2>
  r8 <6 [5]>4. <9 4>4 <8 3>
  r2 r8 <4\+ 2>4.
...
A-XXVIIGloriaOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIGloria
...
A-XXVIIGloriaBassFigures = \figuremode {
  r1
  <6 5>
  r2 <[6]>
  <6 5>4. <\t \t>8 r2
...
A-XXVIICredoOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIICredo
    ...
    e4 r8 e fis4 fis, \noBreak
    h r r2\fermata \bar "||"
    \tempoA-XXVIIEtResurrexit r8 \mvTr g\fE-\tutti c16 d e fis g8 e c d \noBreak
...
A-XXVIICredoBassFigures = \figuremode {
  r1
...
A-XXVIISanctusOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 3/4 \tempoA-XXVIISanctus
    ...
    h2. \noBreak
    e,\fermata \bar "||"
    \time 4/4 \tempoA-XXVIIPleni r8 g' fis d g4 fis8 d \noBreak
    g4 fis8 g e2 %20
    d d4 e8 fis
...
A-XXVIISanctusBassFigures = \figuremode {
  r4 <[6]>2
  r2.
  r
  <6>4 <7> <_+>
...
A-XXVIIBenedictusOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIBenedictus
    ...
    \tempoA-XXVIIOsanna \mvTr g,4\fE-\tutti \clef treble << { h''8 c d4. d8  \noBreak h } \\ { r4 r8 d, e fis g } >>
...
A-XXVIIBenedictusBassFigures = \figuremode {
  r1
...
A-XXVIIAgnusOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIAgnus
    ...
    h g e'2 \noBreak
    d1\fermata \bar "||"
    \clef treble \tempoA-XXVIIDona d''4 d h4. e8 \noBreak
...
A-XXVIIAgnusBassFigures = \figuremode {
  <5>4. <6>8 <4 2>4 <6 [5]>
  \bo <[9]> \bc <[8]> <7> <6\\>
  <7 _+>2 <5 4>4 <\t 3>
  r4 <6 5>8 <_+> <5>4 <6>
