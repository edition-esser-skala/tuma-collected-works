...
A-XXVIIKyrieSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIKyrie
    R1
    ...
    d1\fermata \bar "||"
    \tempoA-XXVIIKyrieB d4. d8 e d16([ c)] h8([ c)] \noBreak %10
    d4. d8 c2
    h8 r r4 r2
    r8 h e2 d4~
    d8 g, c2 h4~
...
A-XXVIIKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- e e -- lei -- son, %2
  e -- lei -- son, e -- lei -- son,
  e -- le -- i --
  son, e -- le -- i -- %5
...
A-XXVIIGloriaSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIGloria
    ...
    \key g \minor \time 3/2 \tempoA-XXVIIQuiTollis \newSpacingSection
      R1.*6 %53
    r2 r \mvTr b\fE^\tutti
    b b d %55
    d1 c2
    ...
    R1.*2 \noBreak %101
    R1.\fermata \bar "||"
    \key g \major \time 4/4 \tempoA-XXVIIQuoniam \newSpacingSection
...
A-XXVIIGloriaSopranoLyrics = \lyricmode {
  Et in ter --
  ra pax,
  pax, pax,
  pax ho -- mi -- ni -- bus
...
A-XXVIICredoSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIICredo
    ...
    R1*8 \noBreak %26
    R1\fermata \bar "||"
    \tempoA-XXVIIEtResurrexit r8 \mvTr d\fE^\tutti e d16([ c)] h8 h a a \noBreak
...
A-XXVIICredoSopranoLyrics = \lyricmode {
  Cre -- do De -- um de De --
...
A-XXVIISanctusSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 3/4 \autoBeamOff \tempoA-XXVIISanctus
    ...
    e2 dis4 \noBreak
    e2.\fermata \bar "||"
    \time 4/4 \tempoA-XXVIIPleni r8 d! d d d4 d \noBreak
    d d8 d d4( cis) %20
...
A-XXVIISanctusSopranoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
...
A-XXVIIBenedictusSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIBenedictus
    R1*6 %6
    \mvTr h'2\pE^\solo c
    ...
    R1*5 \noBreak %29
    R1\fermata \bar "||" %30
    \tempoA-XXVIIOsanna r8 \mvTr g,\fE^\tuttiE h c d4. d8 \noBreak
    h2 a8 fis g a
    h4. h8 a a h h
...
A-XXVIIBenedictusSopranoLyrics = \lyricmode {
  Be -- ne -- %7
  di -- ctus, qui ve -- _
  _ nit in no -- _
...
A-XXVIIAgnusSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIAgnus
    R1*13 %13
...
A-XXVIIAgnusSopranoLyrics = \lyricmode {
  A -- gnus %14
  De -- i, qui tol -- lis %15
  pec --
  ca -- ta mun --
