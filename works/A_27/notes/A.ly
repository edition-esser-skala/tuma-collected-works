...
A-XXVIIKyrieAltoLyrics = \lyricmode {
  Ky -- ri -- e e -- lei -- son, %2
  e -- lei -- son, e -- lei -- son,
  e -- le -- i --
  son, e -- le -- i -- %5
...
A-XXVIIGloriaAltoLyrics = \lyricmode {
  Et in
  ter -- ra pax,
  pax, pax,
  pax ho -- mi -- ni -- bus
...
A-XXVIICredoAlto = {
  \relative c' {
    ...
    R1 \noBreak
    R\fermata \bar "||"
    \tempoA-XXVIIEtResurrexit r8 \mvTr g'\fE^\tutti g g g4. fis8 \noBreak
...
A-XXVIICredoAltoLyrics = \lyricmode {
...
A-XXVIISanctusAlto = {
  \relative c' {
    ...
    fis2 fis4 \noBreak
    e2.\fermata \bar "||"
    \time 4/4 \tempoA-XXVIIPleni r8 g a fis g4 a \noBreak
    g a8 g g2 %20
    fis fis4 g8[ a]
...
A-XXVIISanctusAltoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
...
A-XXVIIBenedictusAlto = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIBenedictus
    R1*29 \noBreak %29
    R1\fermata \bar "||" %30
    \tempoA-XXVIIOsanna r2 r8 \mvTr d\fE^\tuttiE e fis \noBreak
    g4. g8 fis4. fis8
    d4. e8 fis fis g g
...
A-XXVIIBenedictusAltoLyrics = \lyricmode {
  O -- san -- na %31
  in ex -- cel -- sis,
  in ex -- cel -- sis, in ex --
  cel -- sis. %34 finis
...
A-XXVIIAgnusAltoLyrics = \lyricmode {
  A -- gnus %14
  De -- i, qui tol -- lis %15
  pec --
  ca -- ta mun --
