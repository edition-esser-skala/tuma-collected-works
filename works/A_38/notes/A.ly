...
A-XXXVIIIKyrieAltoLyrics = \lyricmode {
  Ky -- ri -- e
  e --
  lei -- son,
  e -- lei -- son,
...
A-XXXVIIIKyrieFugaAlto = {
  \relative c' {
    ...
    R\breve*2
    \mvTr g'2.\fE^\tuttiE g4 e2. e4 %105
    f2. fis4 g2. e4
    fis g2 f e8[ d] e2
...
A-XXXVIIIKyrieFugaAltoLyrics = \lyricmode {
  Ky -- ri -- e e -- %105
  le -- i -- son, e --
  lei -- _ _ _ son,
  e -- lei -- son, e -- lei --
...
A-XXXVIIICumSanctoAltoLyrics = \lyricmode {
  Cum San -- cto %233
  Spi -- ri -- tu
  in glo -- ri -- a De -- i %235
  Pa -- _ _ _ tris,
  a -- men, a --
  men, a -- men, a --
  men,
