...
A-XVIIKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e e --
  lei -- son, e -- lei --
  son,
...
A-XVIIGloriaBasso = {
  \relative c {
    ...
    a' f b4. b8
    a4\fermata \tempoA-XVIIInGloria r r2
    r r4 a %85
    f e8 d e4 fis
    g e d( e)
    a, c( d e)
...
A-XVIIGloriaBassoLyrics = \lyricmode {
  Et in ter -- ra
  pax, pax,
  pax ho -- mi -- ni -- bus
  bo -- nae
...
A-XVIICredoBasso = {
  \relative c {
    ...
    d,8 r r4 r2 \noBreak
    R1\fermata \bar "||" %25
    \tempoA-XVIIEtIncarnatus b4 b8 b b4 b \noBreak
    b b a8. a16 a4
    g g r2
    ...
    \tempoA-XVIIEtResurrexit g,8 g' es f b, b' a g16 f \noBreak
    b8 b a4 b8 g16 f c4
    f, r r d' %35
...
A-XVIICredoBassoLyrics = \lyricmode {
...
A-XVIISanctusBassoLyrics = \lyricmode {
  San -- ctus, %3
...
A-XVIIBenedictusBassoLyrics = \lyricmode {
  O -- san -- %16
  na, o -- san -- na in ex --
  cel -- sis, o -- san -- na, o --
  san -- na in ex -- cel --
...
A-XVIIAgnusBassoLyrics = \lyricmode {
