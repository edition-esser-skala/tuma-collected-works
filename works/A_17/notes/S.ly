...
A-XVIIKyrieSoprano = {
  \relative c' {
    \clef treble
    \key d \dorian \time 4/4 \autoBeamOff \tempoA-XVIIKyrie
    R1*3
...
A-XVIIKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- e e -- %4
  lei -- son, e -- lei -- %5
  son,
  e -- lei --
...
A-XVIIGloriaSoprano = {
  \relative c' {
    \clef treble
    \key d \dorian \time 4/4 \autoBeamOff \tempoA-XVIIGloria
    ...
    f r r2 %80
    R1
    r2 r4 \tempoA-XVIICumSancto \mvTr d\f^\tuttiE
    cis d d4. d8
    cis4\fermata \tempoA-XVIIInGloria r r2
    R1 %85
    r4 d c! h8 a
    h4 cis d c8([ h)]
    c4 h8([ a)] h2
...
A-XVIIGloriaSopranoLyrics = \lyricmode {
  Et in ter -- ra
  pax, pax,
  pax ho -- mi -- ni -- bus
  bo -- nae
...
A-XVIICredoSoprano = {
  \relative c' {
    \clef treble
    \key d \dorian \time 4/4 \autoBeamOff \tempoA-XVIICredo
    ...
    a8 r r4 r2 \noBreak
    R1\fermata \bar "||" %25
    \tempoA-XVIIEtIncarnatus b4 b8 b b4 a \noBreak
    b b c8. c16 c4
    b b b8 b c d
    ...
    r d'8. d16 c8 a \noBreak
    b2( a4.) a8 \bar "||"
    \tempoA-XVIIEtResurrexit g8 b c d16([ es)] d8 b c d16 es \noBreak
    d8 b r4 r g8 g
...
A-XVIICredoSopranoLyrics = \lyricmode {
...
A-XVIISanctusSoprano = {
  \relative c' {
    \clef treble
    \key d \dorian \time 3/2 \autoBeamOff \tempoA-XVIISanctus
    R1.*2
...
A-XVIISanctusSopranoLyrics = \lyricmode {
  San -- ctus, %3
  san --
  _ ctus, %5
  san -- ctus,
...
A-XVIIBenedictusSoprano = {
  \relative c' {
    \clef treble
    \key b \major \time 4/4 \autoBeamOff \tempoA-XVIIBenedictus
...
A-XVIIBenedictusSopranoLyrics = \lyricmode {
  Be -- ne --
  di -- ctus,
  be -- ne -- di -- ctus,
  qui ve -- nit in
...
A-XVIIAgnusSoprano = {
  \relative c' {
    \clef treble
    \key d \dorian \time 4/4 \autoBeamOff \tempoA-XVIIAgnus
    R1*6 %6
...
A-XVIIAgnusSopranoLyrics = \lyricmode {
  A -- gnus %7
