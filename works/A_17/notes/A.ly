...
A-XVIIKyrieAltoLyrics = \lyricmode {
  E -- %2
  lei -- son, e -- lei -- son, e --
  lei -- son, e --
  lei -- %5
...
A-XVIIGloriaAlto = {
  \relative c' {
    ...
    \time 4/4 \tempoA-XVIIQuoniam \newSpacingSection
      R1*10 %81
    r2 r4 \tempoA-XVIICumSancto \mvTr a\f^\tuttiE
    a a a g
    a\fermata \tempoA-XVIIInGloria a f e8 d
    e4 fis g f8([ e)] %85
    f2 g4 a~
    a g fis gis
    a8[( e] a2 gis4)
...
A-XVIIGloriaAltoLyrics = \lyricmode {
  Et in ter -- ra
  pax, pax,
  pax ho -- mi -- ni -- bus
  bo -- nae
...
A-XVIICredoAlto = {
  \relative c' {
    ...
    d8 r r4 r2 \noBreak
    R1\fermata \bar "||" %25
    \tempoA-XVIIEtIncarnatus f4 g8 f g4 es \noBreak
    f f fis8. fis16 fis4
    g g r2
    ...
    g4 g8 g g4. fis8 \bar "||"
    \tempoA-XVIIEtResurrexit g8 g g f f f f f16 f \noBreak
...
A-XVIICredoAltoLyrics = \lyricmode {
...
A-XVIISanctusAltoLyrics = \lyricmode {
  San --
  _ ctus,
  san -- ctus,
...
A-XVIIBenedictusAlto = {
  \relative c' {
    \clef treble
    \key b \major \time 4/4 \autoBeamOff \tempoA-XVIIBenedictus
    R1*14 \noBreak %14
    R1\fermata \bar "||" %15
    \key d \dorian \tempoA-XVIIOsanna R1*4
...
A-XVIIBenedictusAltoLyrics = \lyricmode {
  O -- san -- %20
  a, o -- san -- na in ex --
  cel -- sis, o -- san -- na, o --
  san -- na in ex -- cel -- _
...
A-XVIIAgnusAltoLyrics = \lyricmode {
  A -- gnus De -- i, qui %4
