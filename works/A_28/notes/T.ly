...
A-XXVIIIKyrieTenore = {
  \relative c' {
    ...
    r8 d d d16 d e2 \noBreak
    d1\fermata \bar "||"
    \tempoA-XXVIIIKyrieB r2 h8. c16 d4~ \noBreak %10
...
A-XXVIIIKyrieTenoreLyrics = \lyricmode {
  Ky -- ri -- e e -- lei -- son, %2
  e -- lei -- son, e -- lei -- son,
  e -- le -- i --
  son, e -- le -- i -- %5
...
A-XXVIIIGloriaTenoreLyrics = \lyricmode {
  Et in
  ter -- ra pax,
  pax, pax,
  pax ho -- mi -- ni -- bus
...
A-XXVIIICredoTenore = {
  \relative c' {
    ...
    R1 \noBreak
    R\fermata \bar "||"
    \tempoA-XXVIIIEtResurrexit r8 \mvTr h\fE^\tutti g a h e16 e e8 d \noBreak
    d8. c16 h4 a8 a h h
...
A-XXVIIICredoTenoreLyrics = \lyricmode {
  Cre -- do in u -- num
...
A-XXVIIISanctusTenore = {
  \relative c' {
    ...
    h2 h4 \noBreak
    h2.\fermata \bar "||"
    \time 4/4 \tempoA-XXVIIIPleni r8 h a a h4 a \noBreak
    h a8 h h4( e) %20
    a,2 a4 g8 d'
    d([ e)] c d e4 d8 e
    e([ fis!)] d e fis d r4
...
A-XXVIIISanctusTenoreLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
...
A-XXVIIIBenedictusTenoreLyrics = \lyricmode {
  O -- san -- na in ex -- %32
...
A-XXVIIIAgnusTenoreLyrics = \lyricmode {
  A -- gnus De --
  i, qui tol -- lis
  pec -- ca -- ta mun -- di:
  Mi -- se --
