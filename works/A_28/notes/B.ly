...
A-XXVIIIKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e e -- lei -- son, %2
  e -- lei -- son, e -- lei -- son,
  e -- le -- i --
  son, e -- le -- i -- %5
...
A-XXVIIIGloriaBassoLyrics = \lyricmode {
  Et in
  ter -- ra pax,
  pax, pax,
  pax ho -- mi -- ni -- bus
...
A-XXVIIICredoBasso = {
  \relative c {
    ...
    R1 \noBreak
    R\fermata \bar "||"
    \tempoA-XXVIIIEtResurrexit r8 \mvTr g\fE^\tutti c16([ d)] e([ fis)] g8 e c d16 d \noBreak
...
A-XXVIIICredoBassoLyrics = \lyricmode {
  Cre -- do in De -- um, Pa --
  trem o -- mni -- po -- ten --
...
A-XXVIIISanctusBasso = {
  \relative c {
    ...
    h2 h4 \noBreak
    e,2.\fermata \bar "||"
    \time 4/4 \tempoA-XXVIIIPleni r8 g' fis d g4 fis \noBreak
    g fis8 g e2 %20
    d d4 e8[ fis]
...
A-XXVIIISanctusBassoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
...
A-XXVIIIBenedictusBassoLyrics = \lyricmode {
  O -- san -- na %32
  in ex -- cel -- sis, in ex --
  cel -- sis. %34 finis
}
...
A-XXVIIIAgnusBasso = {
  \relative c {
    ...
    cis4 cis8 cis d!4 d %15
    r2 r4 d
    h g e'2 \noBreak
    d1\fermata \bar "||"
    \tempoA-XXVIIIDona R1*6 %24
    g4 g fis4. h8 %25
    e,4. a8 d,[ e16 fis] g4~
...
A-XXVIIIAgnusBassoLyrics = \lyricmode {
  A -- gnus %7
  De -- i, qui tol -- lis
  pec --
  ca -- ta __ mun -- di: %10
