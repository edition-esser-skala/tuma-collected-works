...
A-XXVIIIKyrieSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIIKyrie
    R1
    ...
    d1\fermata \bar "||"
    \tempoA-XXVIIIKyrieB d4. d8 e d16([ c)] h8([ c)] \noBreak %10
    d4. d8 c2
    h8 r r4 r2
    r8 h e2 d4~
    d8 g, c2 h4~
...
A-XXVIIIKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- e e -- lei -- son, %2
  e -- lei -- son, e -- lei -- son,
  e -- le -- i --
  son, e -- le -- i -- %5
...
A-XXVIIIGloriaSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIIGloria
    ...
    \key g \minor \time 3/2 \tempoA-XXVIIIQuiTollis \newSpacingSection
      R1.*6 %53
    r2 r \mvTr b\fE^\tutti
    b b d %55
    d1 c2
    ...
    R1.*2 \noBreak %101
    R1.\fermata \bar "||"
    \key g \major \time 4/4 \tempoA-XXVIIIQuoniam \newSpacingSection
...
A-XXVIIIGloriaSopranoLyrics = \lyricmode {
  Et in ter --
  ra pax,
  pax, pax,
  pax ho -- mi -- ni -- bus
...
A-XXVIIICredoSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIICredo
    ...
    R1*8 \noBreak %26
    R1\fermata \bar "||"
    \tempoA-XXVIIIEtResurrexit r8 \mvTr d\fE^\tutti e d16([ c)] h8 h a a \noBreak
...
A-XXVIIICredoSopranoLyrics = \lyricmode {
  Cre -- do De -- um de De --
...
A-XXVIIISanctusSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 3/4 \autoBeamOff \tempoA-XXVIIISanctus
    ...
    e2 dis4 \noBreak
    e2.\fermata \bar "||"
    \time 4/4 \tempoA-XXVIIIPleni r8 d! d d d4 d \noBreak
    d d8 d d4( cis) %20
...
A-XXVIIISanctusSopranoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
...
A-XXVIIIBenedictusSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIIBenedictus
    R1*6 %6
    \mvTr h'2\pE^\solo c
    ...
    R1*5 \noBreak %29
    R1\fermata \bar "||" %30
    \tempoA-XXVIIIOsanna r8 \mvTr g,\fE^\tuttiE h c d4. d8 \noBreak
    h2 a8 fis g a
    h4. h8 a a h h
...
A-XXVIIIBenedictusSopranoLyrics = \lyricmode {
  Be -- ne -- %7
  di -- ctus, qui ve -- _
  _ nit in no -- _
...
A-XXVIIIAgnusSoprano = {
  \relative c' {
    \clef treble
    \key g \major \time 4/4 \autoBeamOff \tempoA-XXVIIIAgnus
    R1*13 %13
...
A-XXVIIIAgnusSopranoLyrics = \lyricmode {
  A -- gnus %14
  De -- i, qui tol -- lis %15
  pec --
  ca -- ta mun --
