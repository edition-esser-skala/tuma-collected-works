...
A-XXVIIIKyrieOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIIKyrie
    ...
    r8 b b b a2 \noBreak
    d1\fermata \bar "||"
    \tempoA-XXVIIIKyrieB g,4 r g'4. g8 \noBreak %10
...
A-XXVIIIKyrieBassFigures = \figuremode {
  r2 <6>
  r <4 2>
  r8 <6 [5]>4. <9 4>4 <8 3>
  r2 r8 <4\+ 2>4.
...
A-XXVIIIGloriaOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIIGloria
...
A-XXVIIIGloriaBassFigures = \figuremode {
  r1
  <6 5>
  r2 <[6]>
  <6 5>4. <\t \t>8 r2
...
A-XXVIIICredoOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIICredo
    ...
    e4 r8 e fis4 fis, \noBreak
    h r r2\fermata \bar "||"
    \tempoA-XXVIIIEtResurrexit r8 \mvTr g\fE-\tutti c16 d e fis g8 e c d \noBreak
...
A-XXVIIICredoBassFigures = \figuremode {
  r1
...
A-XXVIIISanctusOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 3/4 \tempoA-XXVIIISanctus
    ...
    h2. \noBreak
    e,\fermata \bar "||"
    \time 4/4 \tempoA-XXVIIIPleni r8 g' fis d g4 fis8 d \noBreak
    g4 fis8 g e2 %20
    d d4 e8 fis
...
A-XXVIIISanctusBassFigures = \figuremode {
  r4 <[6]>2
  r2.
  r
  <6>4 <7> <_+>
...
A-XXVIIIBenedictusOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIIBenedictus
    ...
    \tempoA-XXVIIIOsanna \mvTr g,4\fE-\tutti \clef treble << { h''8 c d4. d8  \noBreak h } \\ { r4 r8 d, e fis g } >>
...
A-XXVIIIBenedictusBassFigures = \figuremode {
  r1
...
A-XXVIIIAgnusOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoA-XXVIIIAgnus
    ...
    h g e'2 \noBreak
    d1\fermata \bar "||"
    \clef treble \tempoA-XXVIIIDona d''4 d h4. e8 \noBreak
...
A-XXVIIIAgnusBassFigures = \figuremode {
  <5>4. <6>8 <4 2>4 <6 [5]>
  \bo <[9]> \bc <[8]> <7> <6\\>
  <7 _+>2 <5 4>4 <\t 3>
  r4 <6 5>8 <_+> <5>4 <6>
