...
A-XXVIIIKyrieViolinoII = {
  \relative c' {
    ...
    \tempoA-XXVIIIKyrieB d'4. d8 g,4. g8 \noBreak %10
...
A-XXVIIICredoViolinoII = {
  \relative c' {
    ...
    h4 r r2\fermata \bar "||"
    \tempoA-XXVIIIEtResurrexit r8 g'\fE g'4 r8 g a,4 \noBreak
    r8 g d'4 r8 d h'4
...
A-XXVIIISanctusViolinoII = {
  \relative c' {
    ...
    e2 dis4 \noBreak
    e2.\fermata \bar "||"
    \time 4/4 \tempoA-XXVIIIPleni r8 d d4 r8 g a fis \noBreak
    h d, d4 d cis %20
    d2 fis,4 g8 a
...
A-XXVIIIBenedictusViolinoII = {
  \relative c' {
    ...
    \tempoA-XXVIIIOsanna r2 r8 d\fE e fis \noBreak
    g4. g8 fis4. fis8
    d4. e8 fis4 g~
