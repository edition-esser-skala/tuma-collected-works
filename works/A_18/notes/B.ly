...
A-XVIIIKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e e --
  lei -- son, e -- lei --
  son,
...
A-XVIIIGloriaBasso = {
  \relative c {
    ...
    a' f b4. b8
    a4\fermata \tempoA-XVIIIInGloria r r2
    r r4 a %85
    f e8 d e4 fis
    g e d( e)
    a, c( d e)
...
A-XVIIIGloriaBassoLyrics = \lyricmode {
  Et in ter -- ra
  pax, pax,
  pax ho -- mi -- ni -- bus
  bo -- nae
...
A-XVIIICredoBasso = {
  \relative c {
    ...
    d,8 r r4 r2 \noBreak
    R1\fermata \bar "||" %25
    \tempoA-XVIIIEtIncarnatus b4 b8 b b4 b \noBreak
    b b a8. a16 a4
    g g r2
    ...
    \tempoA-XVIIIEtResurrexit g,8 g' es f b, b' a g16 f \noBreak
    b8 b a4 b8 g16 f c4
    f, r r d' %35
...
A-XVIIICredoBassoLyrics = \lyricmode {
...
A-XVIIISanctusBassoLyrics = \lyricmode {
  San -- ctus, %3
...
A-XVIIIBenedictusBassoLyrics = \lyricmode {
  O -- san -- %16
  na, o -- san -- na in ex --
  cel -- sis, o -- san -- na, o --
  san -- na in ex -- cel --
...
A-XVIIIAgnusBassoLyrics = \lyricmode {
