...
A-XVIIIKyrieOrgano = {
  \relative c {
    \clef bass
    \key d \dorian \time 4/4 \tempoA-XVIIIKyrie
...
A-XVIIIKyrieBassFigures = \figuremode {
  r1
  r
  r2 <2>8 <[6]>4 <8>8
  <7>4 <6> <6> <6\\ 5!>
...
A-XVIIIGloriaOrgano = {
  \relative c {
    \clef bass
    \key d \dorian \time 4/4 \tempoA-XVIIIGloria
    ...
    f4. e8 d4. c16 b
    a8 d c c, f4 \tempoA-XVIIICumSancto d'-\tuttiE
    a' f b2
    a4\fermata \clef treble \tempoA-XVIIIInGloria << {
      a' f e8 d
      e4 fis g
    } \\ {
      r r d
...
A-XVIIIGloriaBassFigures = \figuremode {
  r1
  r
...
A-XVIIICredoOrgano = {
  \relative c {
    \clef bass
    \key d \dorian \time 4/4 \tempoA-XVIIICredo
...
A-XVIIICredoBassFigures = \figuremode {
...
A-XVIIISanctusOrgano = {
  \relative c {
    \clef bass
    \key d \dorian \time 3/2 \tempoA-XVIIISanctus
...
A-XVIIISanctusBassFigures = \figuremode {
  r1 \bo <[6 4]>4 \bc <[\t 3]>
  r1 \bo <[6 4]>4 \bc <[5 _+]>
  r1.
  r1 \bo <[6 4]>4 \bc <[5 3]>
...
A-XVIIIBenedictusOrgano = {
  \relative c {
    \clef bass
    \key b \major \time 4/4 \tempoA-XVIIIBenedictus
    ...
    \key d \dorian \tempoA-XVIIIOsanna \mvTr d2\fE-\tuttiE e \noBreak
    f4 r8 f g f e a
    f d a'4. g16 f e8 d
    c a a'2 gis4
    a f8 d g4 a %20
...
A-XVIIIBenedictusBassFigures = \figuremode {
  r2. <[6]>4
  r8 q <5> <6!> r4 <7>8 <[7] _!>
  r <[6]> <5> <6!> r4 <5>8 <6\\>
...
A-XVIIIAgnusOrgano = {
  \relative c {
    \clef bass
    \key d \dorian \time 4/4 \tempoA-XVIIIAgnus
    ...
    d c b2 \noBreak %10
    a1\fermata \bar "||"
    \tempoA-XVIIIDona d8 e f g a a, a' g \noBreak
    f d e fis g4 g,
    a2 d4 r
    d g c, f %15
    h, e a,8 h c d
...
A-XVIIIAgnusBassFigures = \figuremode {
  r4 \bo <[6]>2 \bc q4
