...
A-XVIIIKyrieTenoreLyrics = \lyricmode {
  E -- lei -- %3
  son, e --
  lei -- _ _ %5
  son, e -- lei -- _
...
A-XVIIIGloriaTenore = {
  \relative c' {
    ...
    f r r2 %80
    R1
    r2 r4 \tempoA-XVIIICumSancto \mvTr f'\f^\tuttiE
    e f d4. d8
    e4\fermata \tempoA-XVIIIInGloria r r d
    c! h8 a h4 cis %85
    d e8([ f)] e4 d
    d( e) a, r
    r2 r4 e'
...
A-XVIIIGloriaTenoreLyrics = \lyricmode {
  Et in ter -- ra
  pax, pax,
  pax ho -- mi -- ni -- bus
  bo -- nae
...
A-XVIIICredoTenore = {
  \relative c' {
    ...
    d8 r r4 r2 \noBreak
    R1\fermata \bar "||" %25
    \tempoA-XVIIIEtIncarnatus d4 es8 d es4 c \noBreak
    d d c8. c16 c4
    d d g,8g a b
    ...
    a8. b16 c8 c f, f c'4 \noBreak
    d e!8 e d4. d8 \bar "||"
    \tempoA-XVIIIEtResurrexit d d c c d d c c16 c \noBreak
    d8 d c4 d8 b16 c c4
    c r r b %35
...
A-XVIIICredoTenoreLyrics = \lyricmode {
...
A-XVIIISanctusTenoreLyrics = \lyricmode {
  San -- ctus, %2
  san -- ctus,
...
A-XVIIIBenedictusTenore = {
  \relative c' {
    \clef "treble_8"
    \key b \major \time 4/4 \autoBeamOff \tempoA-XVIIIBenedictus
    R1*14 \noBreak %14
    R1\fermata \bar "||" %15
    \key d \dorian \tempoA-XVIIIOsanna R1*2
    \mvTr a2\fE^\tuttiE h
    c4 r8 c d c h e
...
A-XVIIIBenedictusTenoreLyrics = \lyricmode {
  O -- san -- %18
  na, o -- san -- na in ex --
...
A-XVIIIAgnusTenoreLyrics = \lyricmode {
  A -- gnus De -- i, qui
