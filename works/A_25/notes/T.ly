...
A-XXVSanctusTenore = {
  \relative c' {
    ...
    a
    gis
    \mvTr e'8[\fE^\tuttiE f e d c h] %20
    c4. c8 c4
    d8[ e d c h a]
    h4. h8 h4
    c4. c8 c4
...
A-XXVSanctusTenoreLyrics = \lyricmode {
  San --
  ctus,
  san --
  ctus,
...
A-XXVAgnusTenore = {
  \relative c' {
    ...
    r2 g,4. a16([ h)] %30
    c8 c c4 h r8 e(
    h[ c)] d d( a[ h)] c \once \tieDashed c~
    c[ h] a4 g r
    r8 a d4. c16[ h] c4~
    c8[ h16 a] h8 \once \tieDashed b~ b[ a16 g] a8[ h] %35
    c c4 h8 a8.([ h16]) c8([ d])
    e e, e'4.( d16[ c)] h8 d~
    d[ c16 h] a8 a( h) g r \once \tieDashed d'~
    d[ c16 h] c8[ e] d h4 g8
    e4. fis8 g4 g8 g( %40
    a4 h) e, r8 e'(
    d4 h) c a(
    ...
    r8 c([ g a)] h h( g4)
    g g4. g8 g c
    h4 g8 \once \tieDashed g~ g2~
    g g\fermata \bar "|." %79 finis
  }
}

A-XXVAgnusTenoreLyrics = \lyricmode {
  A -- gnus De -- i, qui %9
  tol -- lis pec -- %10
  ca -- ta
  mun -- di: \xE Mi -- se --
