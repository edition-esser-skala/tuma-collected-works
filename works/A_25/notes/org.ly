...
A-XXVDomineOrgano = {
  \relative c {
    ...
    \mvTr c8\fE-\tutti e g g, c e g g,
    c e g g, c4 e8 c
    g'8. a16 h8 g c h16 c a4~ %160
    a8 g16 a fis4~ fis8 e16 \hA fis d8 \hA fis
    g c, d d, g4 h-\solo
    c4. a8 h4. g8
    a4. fis8 g4 d'8 d,
    g h'\pE e, fis \once \tieDashed g4~ g8 f16 e %165
    d8 c4 h8 c c'16 h c8 gis
    a4. c,8 d4 f
    g!4. h,8 c4 e
    f~ f16 f e d e8 a e e,
    \mvTr a\fE-\tutti a' e4 a, c8 a %170
    d c h g! c e g g,
    c4 e8 c f4 g8 g,
    c4 e8 c g'4 \mvTr h8\pE-\solo g
    c c, g'4 a8 g f e
    d e f4 g8 g, g' f %175
    e c g' g, \mvTr c4\fE-\tutti e
    f4. d8 e4. c8
    d4. h8 c e g g, \noBreak
    c e g g, c4^\critnote r\fermata \bar "||"
    \tempoA-XXVQuiTollis \mvTr a2\fE-\tuttiE a \noBreak %180
    a r4 gis
    a g f2
    e r4 cis'
    c2 h
    ...
    es' d
    fis g %190
    \clef "treble_8" d'4. c8 h!4 b
    a2 \clef bass g4. f8
    e4 es d2
    c g
    c4 \tempoA-XXVQuiSedes c g' g, %195
    c8 d e c g'4 g,
    c8 d e c h4 h8 a
    g2 r4 f'
    e e r e
...
A-XXVDomineBassFigures = \figuremode {
  r2. \bo <[4]>8 \bc <[3]> %158
  r1
  <5 4>8 <\t 3> <6>2. %160
  r4 \bo <[6]>2 <_+>4
...
A-XXVQuoniamOrgano = {
  \relative c {
    ...
    e4 e8 f e f %290
    e a f d g g,
    c2^\critnote r4\fermata \bar "||" %292 finis
  }
}

A-XXVQuoniamBassFigures = \figuremode {
  r2. %202
  r
  r
  r %205
...
A-XXVCumSanctoOrgano = {
  \relative c {
    ...
    \mvTr a2\fE-\tutti e'4 c
    f2 e\fermata \bar "||"
    \clef treble \time 6/4 \tempoA-XXVInGloria g'!2. a4 e f %295
    g d2 e4 d c
    d2. \clef "treble_8" c
    e4 h c d a2
    h4 a g a2.
    \clef bass g a4 e f %300
    g d2 e4( d) c
    d2. c4 c' h8 a
    ...
    g2. c
    g c
    g4 \clef treble g''2 \clef "treble_8" c,2. %320
    e4 h c d a h
    c h a \clef bass g2.
    a4 e f g d2
    e4 d c g'2.-\tasto
    ...
    c1.~
    \once \tieDashed c~
    c\fermata \bar "|." %330 finis
  }
}

A-XXVCumSanctoBassFigures = \figuremode {
  r2 <_+>4 <6> %293
  <7>4. <6>8 <_+>2
  r1. %295
  r
...
A-XXVCredoOrgano = {
  \relative c {
    ...
    f f e c g' f g g,
    c d e f d a h g
    c e16 d c8 d e c d d, %10
    g h'16 a g8 a f e d g
    e d c4 d8 g4 fis8
    g g f f e d e c
    f f e f g g, e' c
    f e f d g c, g' g, %15
    c a d h c h a4
    e'8 e f e16 d c8 a a'4~
    a8 gis a g f e f f
    e e, e' g a g a a,
    d e f d g f g g, %20
    c d e d16 c g'8 f g g,
    c4 r8 g' c4 r8 g
    c,4 r8 c g' c, g4
    c8 d c h a h16 c d8 c
    h c16 d e8 d c h a a' %25
    e f16 g a8 g fis g16 a h8 a
    gis fis e4 f? fis
    g gis a a,
    e'8 f16 g a8 g fis g16 a h8 h,
    e a f d r g e c %30
    r f d h r e c h16 a
    e'8 d e e, a a' f d
    g, g' e c e c h c
    g' f g g, c2\fermata \bar "||" %34 finis
  }
}

A-XXVCredoBassFigures = \figuremode {
  r1
  <6>
  r2 q
  r q
...
A-XXVEtIncarnatusOrgano = {
  \relative c {
    ...
    g r8 g a4 a
    h dis e c
    a h e8\fE fis g e %45
    a fis h h, e d! c a
    d h e e, a4 cis
    d f g g,
    c!4. b8 a d a' a,
    d4.-!-\tuttiE d8-! cis4-! d8-! e-! %50
    f4 d e d
    c!8 a a'2 g!4
    f2 e
    d8 e f d e4 d
...
A-XXVEtIncarnatusBassFigures = \figuremode {
  r4 <6>2 <_+>4 %35
  r4 <[5!]>8 <6> <6\\ 5>4 <[5\+] _+>
  r \bo <[6]> \bc <[_!]> <6>
  r1
  <5 4>8 <\t 3>4. <5 4>8 <\t 3>4.
  <5 4>8 <\t 3>4. <5 4>8 <\t 3>4. %40
  <6! 5>2 <9>4 <6>
  r <6> <6 4>8 <5 3> <6 4>4
  <5 \t>8 <\t 3>4. <7>8 <6\\> <\t> <5>
  <10+ 9>4 <6 [_+]> <9\\> <5>
...
A-XXVEtResurrexitOrgano = {
  \relative c {
    ...
    \mvTr c4\fE-\tutti e8 g c4 c,-\solo
    h4. h8 a4. a8
    g4 h c-\tutti e8 g
    c4. c8 h4. h8
    a4. a8 g4 h %70
    c fis,8 g d2
    g,4. g'8-\solo fis4. fis8
    e4. e8 d e fis d
    g4 r c2-\tutti
    a f4 e8 c %75
    g'2 gis4 gis8 gis
    ...
    c4. c'8-\solo h4. h8
    a4. a8 g4 h
    c8 c,\pE e c g'4 g, %85
    a8 h c a e'8. fis16 gis8 \hA fis
    e fis gis e a g? f? e
    d e f e d e f d
    g4 f e8 c d e
    f f, g a16 h c8 d \mvTr e\fE-\tuttiE c %90
    c d e c f g a g
    f4 f8 d c d e c
    e c e c g'8. a16 h8 a
    g g, g' e a8. g16 f8 e
    d f g g, c4. c8-\soloE %95
    h4 g c8 d\pE e c
    g' a h g e a e fis
    g4 g, e'8 fis g e
    c4 c h8 cis dis4
    ...
    a4. c8 d4 c8 a
    e'4 e, a2
    a8 h16 c d e fis gis a4 a
    a,2 \tempoA-XXVMortuorum r4 f'
    gis,2 g \noBreak %105
    g g\fermata \bar "||"
    \clef treble \tempoA-XXVEtVitam
    << {
      c''2 d \noBreak %107
      c4 r8 f f e e4
    } \\ {
      \mvTr r2\fE-\tuttiE g, %107
      a g4 r8 c
    } >>
    \clef bass g,2 a
    g \clef "treble_8" c4 \clef bass c, %110
    d2 c4 r8 f~
    f e e d16 c d8 g, g'4~
    g8 f f e16 d e8 a, a' g
    f e d4 a \clef treble << { c'' } \\ { a } >>
    \clef bass e,2 f %115
    e2. c4
    d e a, a'
    ...
    g c g' g, \clef treble << {
      ...
      r4-\tutti g, %124
      c
    } >> \clef "treble_8" c, \clef bass g a %125
    g2 c,
    d4 f g h,
    c2 g'4 c,
    g c g' g,
...
A-XXVEtResurrexitBassFigures = \figuremode {
  r4 <6>2. %66
  <6>1
  r
  r2 <6>
  ...
  <6 5[!]> <6>
  <7 [5\+] _+>1
  <7>4. <6>8 \bo <[5\+] _+>4 \bc <[\t] _!> %80
  <_+>2 <6>
  q <[6]>4 <5 4>8 <\t 3>
  r2 <6>
  r1
  r2 <5 4>4 <\t 3> %85
  <9> <6> \bo <[6] 4>8 \bc <[5] _+>4.
  r2 <[_+]>4 <6>
  r1
  \bo <[_- _]>2 <6>
  r1 %90
...
A-XXVSanctusOrgano = {
  \relative c {
    ...
    \mvTr c''2\fE-\tutti \clef bass a,,
    d g,
    \clef treble d''' \clef bass h,,
    gis a
    \clef treble e''' \clef bass cis,, %5
    ais a
    g a
    d g,
    c h
    ...
    a h c h
    a d g, c
    g' \clef treble << { g' c8 e d c } \\ { r4 c, f8 a } >> %40
    \clef "treble_8" g,4 \clef bass c, f8 a g f
    e c c4 g c
    g c g'2
    g,1
...
A-XXVSanctusBassFigures = \figuremode {
  r1
  <7 _+>
  r2 <6\\ 5!>
  <6 5>1
...
A-XXVBenedictusOrgano = {
  \relative c {
    \clef bass
    \key e \minor \time 4/4 \tempoA-XXVBenedictus
    \mvTr e4\fE-\solo e8 fis g4 c,8 h
    a4 a' h4. a8
    g4 dis e c
    h h'8 a gis4 gis
    a8 a,16 h c8 a fis'4 fis %5
    g!8 g,16 a h8 g a g a g
    a g a g a g fis! fis'16 e
    dis4 e c d?
    h c a h
    c h8 h e, e'16\pE fis g8 e %10
    h' a g fis e4 e8 fis
    g4 c,8 h a4. a8
    h4 dis e  fis
    g8 e c4 h8 h'4 a8
    g2 gis8 gis gis gis %15
    a d, e e, a h c h
    a4 fis'8 e fis fis fis fis
    g c d d, g4 r8 e
    fis4. ais,8 h4 cis
    d e8 fis g e fis e %20
    d e fis fis, h4\fE h8 cis
    d4 g8 fis e4 e
    fis8\pE gis ais \hA gis fis4 ais,
    h8 cis d \hA cis h \hA cis dis \hA cis
    h h'16 a! g8 fis e fis g e %25
    a g fis4 g8 fis e4
    fis8 e dis4 e g8 a
    h4. gis8 a g a g
    a g a\fE g a g a, g
    a g fis!\pE dis' e4 g8 gis %30
    a4 c8 a h a g g,
    a4 h c\fE gis
    a c h4. dis8
    e c\pE a h e4\fE e8 fis
    g4 c,8 h a4 a' %35
    h4. a8 g4 dis
    e c h h'8 a
    gis gis gis gis a a,16 h c8 a
    fis' fis fis fis g g,16 a h8 g
    a g a g a g a g %40
    a g fis! fis'16 e dis4 e
    c d h c
    a h g8 a h h
    e,2 r\fermata \markOsannaDaCapo \bar "||" %44 finis
  }
}

A-XXVBenedictusBassFigures = \figuremode {
  r2. <6>4
  r2 <_+>4. <4\+>8
  <6>4 <[6]>2 <5>8 <6\\>
  <_+>2 <6 5[!]>4 <\t \t>
...
A-XXVAgnusOrgano = {
  \relative c {
    ...
    a g f4 g c, \noBreak
    g2 c\fermata \bar "||"
    \tempoA-XXVDona c'8-\soloE d e c a d h g \noBreak
    c c,16 d e8 c a d a h %25
    c4 r8 c g' c g g,
    c4.-!-\tuttiE d16-! e-! f8-\parenthesize-! f f4
    e r8 a e f g g
    d e f f e d16 c d4
...
A-XXVAgnusBassFigures = \figuremode {
  r1
  r2 <7->
  <\t>1
  r2 <10- 9>4 <\t 8>
  ...
  r2 <3 5>8 <4 6> <3 5>4
  <10 9>8 <\t 8> <6>4 <7>8 <6>4.
  <7>8 <6>4. <10 9>8 <\t 8> <6>4 %40
  <5! 6>2 <5 4>8 <\t 3>4.
  <7>8 <6>4. <7>8 <6>4.
  <7 5\+ 4>4 <\t \t _+> <5 4> <\t 3>
  r2 <6>
  <7>8 <[5\+] 3>4. <5 4>8 <\t 3>4. %45
  <5 4>8 <\t 3> <[6]>2 <7 5 4>8 <\t \t _+>
  r4 <_!>2.
  r4 <8> <3>2
  r <4- 2>4 <6>
  <4 2> <5>8 <6-> <4 2>8. <6>16 r4 %50
  <10 9>8 <\t 8> <[_!]>4 <4 2> <6>
  r <6 [_!]>2 <6->4
  r <6> q8 <5 3[!]>4.
  r8 <5>2..
