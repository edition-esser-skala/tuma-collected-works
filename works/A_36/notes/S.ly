...
A-XXXVIGloriaSopranoLyrics = \lyricmode {
  Et in ter -- ra
  pax ho -- mi -- ni -- bus
  bo -- nae
...
A-XXXVICredoSoprano = {
  \relative c' {
    ...
    e2. r8 a
    h4 cis8 cis d4 d8 d
    c c a8. a16 g8 \tempoA-XXXVICredoAmen g16[( a] h8^[ h16 c])
    d1~ %40
    d8 d([ c h)] a2
...
A-XXXVICredoSopranoLyrics = \lyricmode {
...
A-XXXVISanctusSoprano = {
  \relative c' {
    ...
    h8^\critnote r r4 r2 \noBreak %10
    R1\fermata \bar "||"
    \tempoA-XXXVIPleni h4 a8 d h16([ a)] h8 r g
    g2.( fis4)
    g r r8 e'4 d8~
    d c4 h a g16 h %15
    c4 c8 c fis,2
...
A-XXXVISanctusSopranoLyrics = \lyricmode {
  San --
  ctus,
  san -- ctus,
  san --
...
A-XXXVIBenedictusSopranoLyrics = \lyricmode {
  O -- san -- na in ex -- %37
  cel -- sis,
  o -- san -- na in ex --
  cel -- sis, ex -- %40
...
A-XXXVIAgnusSopranoLyrics = \lyricmode {
  A -- gnus De -- i, qui
  tol -- lis
  pec -- ca -- ta,
  pec -- ca -- ta mun -- di:
