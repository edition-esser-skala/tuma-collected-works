...
A-XXXVIGloriaAlto = {
  \relative c' {
    ...
    r4 \mvTr g'8\fE^\tutti g fis fis r4
    fis4.\p fis8 fis8. e16 e4
    e4.\f e8 e4 a
    a8 g g([ fis)] g4 r8 g
    a([ g16 fis] e8.) e16 fis4 r8 g16 g %5
    fis8( g4) fis16 fis fis8 fis4 fis8
    gis2 fis4 fis8 fis
    fis2 e!4 e8 e
    eis4. eis8 fis4 r8 fis
    fis e fis4 fis8 fis g dis %10
    e[ fis g dis] e[ fis] g4
    fis4. fis8 fis4 r
    r2 \mvTr fis4.\pE^\solo h16 a!
    g4. fis16 e fis([ e)] d8 r4
    a'8([ fis)] e([ d)] h' g r4 %15
    d8[ e16 fis] g[ h32 a g16 fis] e8[ fis16 g] a[ c32 h a16 g]
    fis8 g16 e fis4 g r
    R1*15 \noBreak %32
    R1\fermata \bar "||"
    \key a \minor \tempoA-XXXVIQuiTollis
      R1 \noBreak
    r4 \mvTr e\fE^\tutti f2 %35
    e4 e f f
    r8 f f f e4 e
    R1
    r4 fis8 fis g!4 h~
    h ais h8[ a?] g[ fis16 e] %40
    fis2 e4 r
    R1*7 %48
    r4 \mvTr f!8\fE^\tutti a dis,2
    e4 r r e8 g! %50
    cis,2 d!4 a'8 a
    gis4 a a( gis)
    a r r2 \noBreak
    ...
    \key e \minor \tempoA-XXXVIQuoniam
      R1*11 %65
    r8 \mvTr g\fE^\tutti a fis g8. g16 fis8 fis
    fis e16 e fis8 fis e2
    fis4 \tempoA-XXXVIAmen r8 e( dis4) e8([ fis)]
    ...
    a8 g fis4. cis8 d([ e)]
    fis2. r8 h,(
    h'16[ c! h a] g_[ a g fis)] e8 a,( a'16[ h a g] %75
    fis[ g fis e)] d8 d e4~ e16[ fis g a]
    fis8 g g([ fis)] g4 r8 e(
...
A-XXXVIGloriaAltoLyrics = \lyricmode {
  Et in ter -- ra
  pax ho -- mi -- ni -- bus
  bo -- nae, bo -- nae
  vo -- lun -- ta -- tis. Lau --
...
A-XXXVICredoAlto = {
  \relative c' {
    ...
    \mvTr g'4\fE^\tutti a8 fis g4. fis8
    g4 g8 g fis fis g4
    ...
    e2 fis4 r
    R1
    \mvTr a4\pE^\solo g16([ fis)] e([ d)] a'4. a8
    dis, fis a g16 fis g8 e r4 %10
    e4. g8 f4 e8 e
    a4 g fis8. fis16 h,8 fis'
    h4. a8 gis2
    a4 r r8 e a g
    fis2 g4 r %15
    r g g fis8([ e)]
    d[ fis] h[ a!16 g] \tuplet 3/2 8 { \sbOn fis[ e fis g fis e] \sbOff } cis8. cis16
    h4 r r2
    R1*12 \noBreak %30
    R1\fermata \bar "||"
    \tempoA-XXXVIEtResurrexit
      r8 \mvTr g'\fE^\tutti g fis g g a([ fis]) \noBreak
    g g g8. g16 d8 d fis g
    g8. fis16 fis8 a a4( gis8.) gis16
    a8 e e d e e e e %35
    e e fis! fis e e e dis
    e g g4 g fis8 fis
    g g e16 e e e fis8 fis fis g
    g4( fis) \after 8 \tempoA-XXXVICredoAmen g r
    ...
    g e'16([ fis] gis8[ a16 h] a8) e e4~ %50
    e e e( dis)
    e r r8 a([ g! f]
    e[ d c h)] a4 r
    r8 g'[ fis e] d[ g fis e]
    d[ c h \once \tieDashed h'~] h4 a8[ g] %55
    fis h[ a g] fis[ e d c]
    h[ fis'] g4 g(^\critnote fis)
    g8 h,([ c d] e[ fis g a)]
    h g4 g8 g2~
    g4 g g2 %60
...
A-XXXVICredoAltoLyrics = \lyricmode {
  ...
  Cre -- do in u -- nam san -- %32
  ctam ca -- tho -- li -- cam et a -- po --
  sto -- li -- cam Ec -- cle -- si --
  am, con -- fi -- te -- or u -- num ba -- %35
  ptis -- ma in re -- mis -- si -- o -- nem
  pec -- ca -- to -- rum, et ex --
  pe -- cto re -- sur -- re -- cti -- o -- nem mor -- tu --
  o -- rum,
  a -- %40
  men, a -- men, a --
...
A-XXXVISanctusAlto = {
  \relative c' {
    ...
    R1\fermata \bar "||"
    \tempoA-XXXVIPleni
      g4 a8 fis g16([ fis)] g8 r d \noBreak
    e2.( d8[ c)]
    h4 r r8 e( fis8.) fis16
    e4 d( c) h8 h %15
    e4 e8 e e4( dis)
    e8 e e gis a4 e
...
A-XXXVISanctusAltoLyrics = \lyricmode {
  San --
  ctus,
  san -- ctus,
  san --
...
A-XXXVIBenedictusAlto = {
  \relative c' {
    ...
    \key e \minor \tempoA-XXXVIOsanna
      r8 \mvTr g'\fE^\tutti fis fis g4 g \noBreak
...
A-XXXVIBenedictusAltoLyrics = \lyricmode {
  O -- san -- na in ex -- %37
  cel -- sis, in ex -- cel --
  _
  sis, in ex -- %40
...
A-XXXVIAgnusAlto = {
  \relative c' {
    ...
    R1*13 %13
    r2 r4 \mvDl fis8\fE^\tutti fis
    e4 e8 e e4 d8 fis %15
    fis2 g4 g
    g fis g( fis8[ e)] \noBreak
    fis1\fermata \bar "||"
    \key e \minor \tempoA-XXXVIDona R1*4 %22
    r4 \mvTr h2\fE^\tutti a4~
    a g2 fis4
    e2 fis4 g~ %25
    g fis8[ e] fis4 r
...
A-XXXVIAgnusAltoLyrics = \lyricmode {
  A -- gnus %14
