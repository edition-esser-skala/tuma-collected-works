...
I-IILectioPrimaViolinoI = {
  \relative c' {
    ...
    d'8\fE es16( d) b'8 g16( es) c2
    c8 d16( c) a'8 \once \slurDashed fis16( c) h2
    c8 d16( c) g'8 es16( c) fis4 g~
    g fis\trill g2\p
    a1~ %5
    a4 g8 g g4 r
    g1~
    g4 fis\trill g8 d16( b) g8 \once \slurDashed d16( b)
    g4 r a''2~
    a~ a4. g8 %10
    f! a16( f) d8 a16( f) d4 r
    f'2~ f8 d d4
    cis8 e16( \hA cis) a8 \once \slurDashed e16( cis) a4 e''
    d2~ d4 \after 8 \tempoI-IILectioPrimaB r
    r2 r4 g~ %15
    g fis\trill g8 d16( b) g8 \once \slurDashed d16( b)
    \kneeBeam g8 es''16( c) a4 g \tempoI-IILectioPrimaC r
    c1
    c~
    c2 b %20
    c8 g'16( e) c8 g16( e) c4 r
    c'2~\fE c4 b~
    b as b c
    a2 a4\fermata r8 a
    b4 d8 c b4 d~ %25
    ...
    c d c g f4 e8 f
    f4 es d2~ %30
    d \kneeBeam c8 g''16( es) c8 g16( es)
    c4 es'\p es2~
    es d8 f16( d) b8 f16( d)
    b4 d'2 c4
    c2 d8 a'16( fis) d8 a16( fis) %35
    d4 r e2
    e8(-.\p e-. e-. e-.) e(-. e-. d-. d-.)
    d(-. d-. d-. d-.) d(-. d-. d-. d-.)
    cis(-.\pp cis-. cis-. cis-.) cis4\fermata r
    r2 r8 d' d d %40
    d4 r r cis\trill\f \noBreak
    d r r2\fermata \bar "||"
    \tempoI-IIResponsoriumPrimum d4.\fE d8 g,4. g8 \noBreak
    a c b a b16 g a b c d e fis
    g8 g,4 a8 b c16 d es f g a %45
    b8 b, r es, d es16 f g a b c
    d8 d r c b16 g b c d4~ \noBreak
    d c\trill d2\fermata \bar "||"
    \tempoI-IIResponsoriumPrimumB d4\fE d es b8 c \noBreak
    d4 a8 b c2 %50
    b a
    g4 b2 d4
    c g8 a b c d4
    ...
    R1\fermata \bar "||" %70
    \tempoI-IIResponsoriumPrimumB d'4\fE d es b8 c \noBreak
    d4 a8 b c2 %50
    b a
    g4 b2 d4
    c g8 a b c d4
...
I-IILectioSecundaViolinoI = {
  \relative c' {
    ...
    r2 as'\p
    g f
    es d8 \slurDashed es16( d) g( f) h( c) \slurSolid
    r8 es,16( d) g( f) h( c) as8( \grace g16 f8) d4\trill
    c r as'2 %5
    g f
    es d8 es16( d) g( f) h( c)
    g,4 r8 h' h4 r8 \hA h
    c es,16( d) g( f) h( c) c,2
    c des %10
    c~ c8 b! f'4
    e f2 e4
    f8 as16( g) c( b) e( f) f,4 r
    c'2 r4 c8\fE f,
    des'4. des8 des4 c~ %15
    c h c g8 g16 g
    c8 c c4 c b
    r b8 b h4 c~
    c h\trill c r
    es2\p d~ %20
    d4. c8 b! g16( fis) b( a) fis'( g)
    g,4 g' f2
    f es8 es,16( d) g( f) h( c)
    c,4 c'2 b4
    b es g2 %25
    fis r4 a,8\f a
    d8. d16 d4 d2
    ...
    c d!~
    d c
    d r8 b16( a) c( b) fis'( g)
    a,2 d
    c4. a8 b b16( a) c( b) fis'( g) %40
    g,4 d' es2~
    es d~
    d4 es16 c g'8 g4 fis \noBreak
    g8 b,16( a) c( b) fis'( g) g,8 g, g4\fermata \bar "||"
    \tempoI-IIResponsoriumSecundum es''2\fE d \noBreak %45
    c~ c4 r
    b!2 as
    g \tempoI-IIResponsoriumSecundumB r
