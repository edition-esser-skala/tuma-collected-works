...
I-IILectioPrimaOrgano = {
  \relative c {
    ...
    d2 b
    a1
    fis'2 g4. \tempoI-IILectioPrimaB g8
    c,16. es32 f8 b,16. d32 es8 a,16. c32 d8 g,16. b32 c8 %15
    d4 d, g r
    r8 c d d, g4 \tempoI-IILectioPrimaC g'
    e1~
    e2 f
    des1 %20
    c2~ c4 r
    ...
    gis4 r r a\f \noBreak
    d r r2\fermata \bar "||"
    \tempoI-IIResponsoriumPrimum \mvTr g4\fE-\tutti f es b \noBreak
    c d g, r8 d'
    b g' es f!16 es d8 b r c %45
    b c16 d es f g a b8 b, r a
    g a16 b c d e fis g8 g, g' f?
    es2 d \bar "||"
    \clef treble \tempoI-IIResponsoriumPrimumB << {
      d''4 d es b8 c
      d4 a8 b c2 %50
      b
    } \\ {
    ...
    d \noBreak
    g,\fermata \bar "||" %65
    \clef "treble_8" \tempoI-IIResponsoriumPrimumC
...
I-IILectioPrimaBassFigures = \figuremode {
  r4 <6> <4 2>2
  <6 5> <4! _->
  <6> <7 [5!] _+>4 <6 4>
  <5 \t> <\t _+> <[5]>4. <6>8
...
I-IILectioSecundaOrgano = {
  \relative c {
    ...
    c2~ c4 r
    es2 es4 d
    es2 \clef "treble_8" \tempoI-IIResponsoriumSecundumB r8 es'[ d] \clef bass b
    ...
    g1 \noBreak
    c\fermata \bar "||"
    \clef "treble_8" \tempoI-IIResponsoriumSecundumD
      r4 \mvTr as'\pE-\solo es'2 \noBreak %70
    e4. e8 f f, r f
    des'2 c4 r8 c
    f4 d8 es! b2 \noBreak
    es,1\fermata \bar "||"
    \clef bass \tempoI-IIResponsoriumSecundumC
...
I-IILectioSecundaBassFigures = \figuremode {
  r2 r8 <9 [_-]> <6>4
