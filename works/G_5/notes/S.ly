...
G-VaSoprano = {
  \relative c' {
    \clef treble
    \key f \dorian \time 4/4 \tempoG-Vaa \autoBeamOff
    \mvTr c'2\fE^\tutti c
...
G-VbSoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \autoBeamOff \tempoG-Vb
...
G-VcSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoG-Vca
...
G-VdSoprano = {
  \relative c' {
    \clef treble
    \key f \dorian \time 4/4 \autoBeamOff \tempoG-Vd
...
G-VeSoprano = {
  \relative c' {
    \clef treble
    \key d \phrygian \time 4/4 \autoBeamOff \tempoG-Ve
...
G-VgSoprano = {
  \relative c' {
    \clef treble
    \key es \major \time 3/2 \autoBeamOff \tempoG-Vg
...
G-VhSoprano = {
  \relative c' {
    \clef treble
    \key f \dorian \time 4/4 \autoBeamOff \tempoG-Vha
