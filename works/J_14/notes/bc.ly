...
J-XIVAllegroContinuo = {
  \relative c {
    \clef bass
    \key c \major \time 4/4 \tempoJ-XIVa
    c4\fE r r2
    R1
    c4 r f\p r
...
J-XIVAllegroBassFigures = \figuremode {
  r1
  r
  <7->
  q
...
J-XIVAndanteContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key f \major \time 2/4 \tempoJ-XIVb
...
J-XIVAndanteBassFigures = \figuremode {
  r8 r <6> q4
  <\t>8 <7> <4> <6>
  <4> <7> <6 5>4
  <4>8 <6> <4> <3>
...
J-XIVMenuettoContinuo = {
  \relative c {
    \clef bass
    \key c \major \time 3/4 \tempoJ-XIVc
    c4\fE e d
    c8 d e d c4
    d2 c4
    h g c
    ...
    a g g, \noBreak
    c g c,\fermata \bar ":|.|:"
    \key c \dorian \tempoJ-XIVcb r4 c'8 c c4 \noBreak %25
    r c'8 c c4
    f, r f
    g d g,
    r f'8 f f4
...
J-XIVMenuettoBassFigures = \figuremode {
  r4 <6> q
  r8 q q q4.
  <6>2 <6 4>4
  <6 5>2.
...
J-XIVFinaleContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key c \major \time 2/4 \tempoJ-XIVd
    c4\fE f
    g c,
    h h'
    c c,
...
J-XIVFinaleBassFigures = \figuremode {
  r4 <6>
  <4>8 <3>4.
  <6>4 <7>8 <6>16 <5>
  <9 4>4 <8 3>
