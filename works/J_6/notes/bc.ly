...
J-VIIntroContinuo = {
  \relative c {
    \clef bass
    \key f \dorian \time 4/4 \tempoJ-VIIntro
    ...
    c,4 r16 c f16. as32 c,4 r16 c e16. g32 %10
    f8 des(-.\pp des-. des-.) c2\fermata \bar "||" %11 finis
  }
}

J-VIIntroBassFigures = \figuremode {
  r8 r2 <6 5>4 <7 _!>
...
J-VIFugaContinuo = {
  \relative c {
    \clef bass
    \key f \major \time 4/4 \tempoJ-VIFuga
    R1*10 %10
    r2 f\fE
    d'4. c8 b a g4~
    g8 a16 b c8 b a g f4~
    f8 g16 a b8 a g f e4~
    e8 f16 g a8 g f e d c %15
    h g a h c4 c'~
    c h c r
    r8 f, f' e d16 e c d h c a h
    g8 f e d c16 c' h c a h g h
    f8 e d c h16 h' a h g a f g %20
    e8 d c h a4 r
    r2 r16 c d e f8 e
    r16 d e f g8 f r16 e f g a8 g
    fis d g f e c f16 f g a
    g8 a16 b! c8 b a g f4 %25
    r2 r4 r8 g
    c4~ c16 c d e f4. f,8
    b4~ b16 b c d e4. e,8
    a4~ a16 a b c d8 c b a
    g a16 b c8 b a16 f g a b8 a %30
    ...
    c8 d16 e f8 e d c h c16 d
    e8 d r16 c d e f8 e r16 d e f %40
    g8 f r16 e f g a8 g r16 f g a
    h8 a r16 g a h c d h c a a h c
    d8 c h g c4. b8
    a f r4 r8 b, b' a
    g16 a f g e f d e c8 b a g %45
    ...
    b16  b' a b g a f g e8 d c b
    a4 r f'2 %65
    d'4. c8 b a g4~
    g8 a16 b c8 b a g f4~
    f8 g16 a b8 a g f e4~
    e8 f16 g a8 g f4 r16 f g a
    b8 a g a16 h c4 c, %70
    c1~-\tastoE
    c~
    c~
    c
    r8 c c' b! a16 b g a f g e f %75
    d e c d b c a b g g' f g e f d e
    c d b c a b g a f f' e f d e c d
    b c a b g a f g e8 d'' c b
    a g f e d c b a
    g16 g' f g e f d e c2 %80
    c, f4 r\fermata \bar "|." %81 finis
  }
}

J-VIFugaBassFigures = \figuremode {
  r1*11 %11
  <6>4. q8 q q q <5>
  <4> <\t> <6> q q q q <5>
  <4> <\t> <6> q q q q <5>
  <4> <\t> <6> q q4. \once \bassFigureExtendersOn q8 %15
  ...
  r4 <8 6>8 <6 4> <5 3>2
  r4 <8 6>8 <6 4> <5 3>2
  r4 <8 6>8 <6 4> <5 3>4. \once \bassFigureExtendersOn q8
  <7>4 <3>8 <\t> <6 5>2 %30
  q q4 <6 5 _!>
...
J-VIMenuetContinuo = {
  \relative c {
    \clef bass
    \key f \major \time 3/4 \tempoJ-VIMenuet
    r4 f-!\fE g-!
    a-! b-! c-!
    ...
    f c' c, \noBreak
    f2 r4\fermata \bar ":|.|:"
    \key b \major \tempoJ-VIMenuetB \mvTr r4\p-\sempre b b, \noBreak %35
    r b' b,
    r b' b,
    r f' f,
    b b'2~
...
J-VIMenuetBassFigures = \figuremode {
  r2.
  r
  r
  <5>
...
J-VICapricioContinuo = {
  \relative c {
    \clef bass
    \twotwotime \key f \major \time 2/2 \tempoJ-VICapricio
    f2\fE c
    r4 b b8 c d e
    f4 f, f'2
    g c,
...
J-VICapricioBassFigures = \figuremode {
  r1
  r
  <6 4>2 <5 3>
  <9 4> <7 5>
