...
A-XIKyrieSopranoLyrics = \lyricmode {
  Ky -- ri --
  e e --
  _
  lei --
...
A-XIGloriaSopranoLyrics = \lyricmode {
  Lau -- da -- mus
...
A-XICredoSopranoLyrics = \lyricmode {
...
A-XISanctusSopranoLyrics = \lyricmode {
  San -- ctus, %3
...
A-XIBenedictusSopranoLyrics = \lyricmode {
  Be -- ne --
  di -- ctus, qui
  ve -- nit in
  no -- mi -- ne
...
A-XIAgnusSopranoLyrics = \lyricmode {
  A -- gnus %22
  De -- i, qui
  tol -- lis pec -- ca -- ta
  mun -- di: Mi -- se -- %25
