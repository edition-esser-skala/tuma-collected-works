...
A-XIKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- %7
  e e --
  lei --
  son, e -- %10
...
A-XIGloriaBasso = {
  \relative c {
    ...
    e c8 c g g g4 \noBreak
    c r r2\fermata \bar "||"
    \tempoA-XIQuiTollis r4 \mvTr e\fE^\tutti e dis8 dis \noBreak
    e4 d c2 %10
    h r
    r4 e8 e d!2
    c4 c8 c f4 d
...
A-XIGloriaBassoLyrics = \lyricmode {
  Do -- mi -- ne %3
...
A-XICredoBassoLyrics = \lyricmode {
  Et ex %2
...
A-XISanctusBassoLyrics = \lyricmode {
  San -- ctus, %3
...
A-XIBenedictusBassoLyrics = \lyricmode {
  Be -- ne -- %3
  di -- ctus, qui
  ve -- nit in %5
  no -- mi -- ne
...
A-XIAgnusBassoLyrics = \lyricmode {
  A -- gnus %28
  De -- i, qui
  tol -- lis pec -- %30
  ca -- ta
