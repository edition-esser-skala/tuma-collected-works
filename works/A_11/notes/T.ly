...
A-XIKyrieTenoreLyrics = \lyricmode {
  Ky -- ri -- %6
  e e --
  _
  lei --
...
A-XIGloriaTenore = {
  \relative c' {
    ...
    fis4 h h2 \noBreak
    h1\fermata \bar "||" %25
    \tempoA-XIQuoniam r2 r4 r8 \mvTr a\pE^\solo \noBreak
...
A-XIGloriaTenoreLyrics = \lyricmode {
...
A-XICredoTenoreLyrics = \lyricmode {
...
A-XISanctusTenoreLyrics = \lyricmode {
  San -- ctus, %3
...
A-XIBenedictusTenoreLyrics = \lyricmode {
...
A-XIAgnusTenoreLyrics = \lyricmode {
  A -- gnus %7
  De -- i, qui
  tol -- lis pec --
  ca -- ta %10
