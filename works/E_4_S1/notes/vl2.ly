...
E-IV-SIViolinoII = {
  \relative c' {
    ...
    r b-!\fp g,( b) d16\f f f f f f f f
    g as g f es8 d\trill es b es4 %5
    R1
    r2 r8 g'-!\fp es,( g)
    r f'-!\fp d,( f) es4 r
    r f16\fE f f f g g f es f8 es
    es\trill d r4 r2 %10
    R1
    r8 d'-!\fp b,( d) r c'-!\fp a,( c)
    b4 r r2
    r r8 d\p f g
    a4 r r8 \hA a c \hA a %15
    b16 es\fE es es es es es es d es d c b8 a\trill
    b f b,4 r2
    r8 as'!-!\fp as,( c) r2
    r8 g''-!\fp es,( g) r2
    R1 %20
    ...
    ges, es' \hA ges, es' f,4 %135
    f2.\trill
    g!2.\fermata \bar "|." %137 finis
  }
}
