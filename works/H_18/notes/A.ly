...
H-XVIIIKyrieAltoLyrics = \lyricmode {
  Ky -- ri -- %6
  e e -- lei -- son, e --
  lei -- son, e --
  lei -- son, e -- lei --
...
H-XVIIISanctaAltoLyrics = \lyricmode {
  San -- cta,
  san -- cta Ma --
  ri -- a,
  san -- cta
...
H-XVIIISpeculumAltoLyrics = \lyricmode {
  Vas spi -- ri -- tu -- %24
  a -- le, %25
  vas ho -- no --
  ra -- bi -- le,
...
H-XVIIISalusAlto = {
  \relative c' {
    ...
    r g g g \noBreak
    fis b a2 \bar "||" %10
    \tempoH-XVIIIRegina d,4^\critnote r r2 \noBreak
    R1*10 %21
    ...
    a4 a8 a b4 b8 b %50
    g4. g8 fis4 fis
    \tempoH-XVIIIMiserere r g8 g g4 g
    r as8 g fis4 g
    g( fis) g g8 g
    g4 g g2 %55
...
H-XVIIISalusAltoLyrics = \lyricmode {
  Sa -- lus
  in -- fir -- mo -- _
  _ rum,
  re -- fu -- gi --
