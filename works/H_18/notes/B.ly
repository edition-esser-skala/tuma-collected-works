...
H-XVIIIKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e e -- %8
  lei -- son, e -- lei -- _
  _ son, e -- %10
  lei -- son,
...
H-XVIIISanctaBassoLyrics = \lyricmode {
  San -- cta,
  san -- cta Ma --
  ri -- a,
  san -- cta
...
H-XVIIISpeculumBassoLyrics = \lyricmode {
  Vas spi -- ri -- tu -- %24
  a -- le, %25
  vas ho -- no --
  ra -- bi -- le,
...
H-XVIIISalusBasso = {
  \relative c {
    ...
    es4. es8 d4 d
    \tempoH-XVIIIMiserere r h8 h c4 c
    r c8 c d4 d
    d2 g,4 g'8 g
    g4 g g,2 %55
...
H-XVIIISalusBassoLyrics = \lyricmode {
  Sa -- lus
  in -- fir -- mo --
  rum,
  re -- fu -- gi --
