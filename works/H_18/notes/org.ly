...
H-XVIIIKyrieOrgano = {
  \relative c {
    \clef treble
    \key g \minor \time 4/4 \tempoH-XVIIIKyrie
    << {
...
H-XVIIIKyrieBassFigures = \figuremode {
  r1
  r2 <5 4>4 <\t _+>
  r <6>8 <5> <4 2\+> <\t \t>4.
  <4 2>4 <6>2.
...
H-XVIIISanctaOrgano = {
  \relative c {
    \clef bass
    \key d \phrygian \time 3/4 \tempoH-XVIIISancta
...
H-XVIIISanctaBassFigures = \figuremode {
  r2.
  <6! 5>4 <5! 4> <\t _+>
  r2 <[6 _!]>4
  r2.
...
H-XVIIISpeculumOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 4/4 \tempoH-XVIIISpeculum
...
H-XVIIISpeculumBassFigures = \figuremode {
  r4. <[6\\]>8 <6>4. <[5!]>8
  r4 <6>8 <[6]> r2
  <_+>4 <[6]>2.
  <6>4 <7>8 <[5!] _+> r4 <6\\>
...
H-XVIIISalusOrgano = {
  \relative c {
    \clef treble
    \key g \minor \time 4/4 \tempoH-XVIIISalus
    ...
    r cis cis2 \noBreak
    d1 \bar "||" %10
    \tempoH-XVIIIRegina g,8 a \mvTr b\pE-\soloE g c b a f \noBreak
    b c d a b a g c
    f, f' f es! d4 c8 f
    b, c d b a g a d
    g, a b h c d es d %15
...
H-XVIIISalusBassFigures = \figuremode {
  r1
  <4! 2>2 <7 [5!] _+>4 <6 4>
  <5! \t> <\t _+> <[5!]>2
  r <6 5>
