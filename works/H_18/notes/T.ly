...
H-XVIIIKyrieTenoreLyrics = \lyricmode {
  Ky -- ri -- %8
  e e -- lei --
  son, e -- %10
  lei -- son,
...
H-XVIIISanctaTenoreLyrics = \lyricmode {
  San -- cta,
  san -- cta Ma --
  ri -- a,
  san -- cta
...
H-XVIIISpeculumTenoreLyrics = \lyricmode {
  Vas spi -- ri -- tu -- %24
  a -- le, %25
  vas ho -- no --
  ra -- bi -- le,
...
H-XVIIISalusTenore = {
  \relative c' {
    ...
    c4 c8 c b4 b8 b %50
    es4. es8 a,4 a
    \tempoH-XVIIIMiserere r d8 d es4 es
...
H-XVIIISalusTenoreLyrics = \lyricmode {
  Sa -- lus
  in -- fir -- mo --
  rum,
  re -- fu -- gi --
