...
H-XVIIIKyrieSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoH-XVIIIKyrie
    R1*6 %6
...
H-XVIIIKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- e e -- %7
  lei --
  son, e -- lei --
  son, e -- %10
...
H-XVIIISanctaSoprano = {
  \relative c' {
    \clef treble
    \key d \phrygian \time 3/4 \autoBeamOff \tempoH-XVIIISancta
...
H-XVIIISanctaSopranoLyrics = \lyricmode {
  San -- cta,
  san -- cta Ma --
  ri -- a,
  san -- cta
...
H-XVIIISpeculumSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoH-XVIIISpeculum
...
H-XVIIISpeculumSopranoLyrics = \lyricmode {
...
H-XVIIISalusSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoH-XVIIISalus
    ...
    b b b b \noBreak
    a g g( fis) \bar "||" %10
    \tempoH-XVIIIRegina g4 \mvTr d'\pE^\soloE es8 d16([ c)] f8 es \noBreak
    d16([ c)] b8 r f' d c b4
    ...
    d4 d8 d d4 d8 d %50
    d4 c d d
    \tempoH-XVIIIMiserere r d8 d d4 c
    r c8 c c4 b!
    a2 g4 h8 h
    c4 d es( d8[ c)] %55
...
H-XVIIISalusSopranoLyrics = \lyricmode {
  Sa -- lus
  in -- fir -- mo --
  rum,
  re -- fu -- gi --
