...
F-IIIStabatOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 4/4 \tempoF-IIIStabatMater
...
F-IIIStabatBassFigures = \figuremode {
  r2. <6>4
  <6 5>2 <7 _!>
  <6- 5 [_-]>4 <5-> <6 5> <_->
  r2 r8 <_->4.
...
F-IIIOQuamOrgano = {
  \relative c {
    \clef bass
    \key d \phrygian \time 3/4 \tempoF-IIIOQuam
    \mvTr d2.\fE-\tuttiE
    cis2 d4
    r d2
    c! b4
...
F-IIIOQuamBassFigures = \figuremode {
  r2.
  <7 5 [_!]>
  r
  <4\+ 2>2 <6>4
...
F-IIIQuisEstOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 4/4 \tempoF-IIIQuisEst
    ...
    c a d d, g4 \tempoF-IIIProPeccatis g'
    f!1
    es~
    es2 e
    f1 %15
    ...
    es4 c g' g,
    c8 r r4 fis,\ppE g
    \tempoF-IIIEiaMater c8 d es\pE c f es d g
    c,4 b!8 es c b a d
    g,4 b c d %25
    es a, b8 c d b
    f' f, as f b2
...
F-IIIQuisEstBassFigures = \figuremode {
...
F-IIISanctaOrgano = {
  \relative c {
    \clef treble
    \key g \minor \time 4/4 \tempoF-IIISancta
...
F-IIISanctaBassFigures = \figuremode {
  r2. <6>4
  <5 4> <\t 3> <4 2> <5>
  <6 5>2 <4 2>4 <6 5>
  r2. <_!>4
...
F-IIIFacTecumOrgano = {
  \relative c {
    \clef bass
    \key c \dorian \time 3/4 \tempoF-IIIFacTecum
    \mvTr c2\fE-\solo es4
    f es d8 c
    h2.
    c2 r4
...
F-IIIFacTecumBassFigures = \figuremode {
  r2 <6>4
  <6-> <6>2
  <5>2 <6>4
  r2.
...
F-IIIPlagisOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 4/4 \tempoF-IIIFacPlagis
    ...
    g,2 \tempoF-IIIMorietur r4 \clef treble g''8\p g
    << { d'2. c4~ c } \\ { r4 g,8 g es'2
    d4 } >>
    \clef bass g,,8 g es'2
    \once \tieDashed d1~ %25
    \once \tieDashed d2~ d\fermata
    \clef treble \tempoF-IIIFacUt << {
      g'4.\fE g8 es'4. es8
      d4. h8 c g c4~
      c8 b a4 g8 a b a
...
F-IIIPlagisBassFigures = \figuremode {
  r1
  r2. <6>8 <6 5->
