...
F-IIIOQuamSopranoLyrics = \lyricmode {
  O quam
  tri -- stis
  et af --
  fli -- cta
...
F-IIIQuisEstSoprano = {
  \relative c' {
    ...
    a4. a8 g4 \tempoF-IIIProPeccatis r
    R1*11 %22
    \tempoF-IIIEiaMater R1
    r4 g8 g a b c b16([ a)]
...
F-IIIQuisEstSopranoLyrics = \lyricmode {
  Qui non
  fle -- ret, si vi --
  de -- ret in tan --
...
F-IIISanctaSopranoLyrics = \lyricmode {
  San -- cta ma --
  ter, i --
  stud a --
  gas, cru -- ci --
...
F-IIIPlagisSoprano = {
  \relative c' {
    ...
    b4 b \tempoF-IIIMorietur r g8\p g
    d'2. c4~
    c b2 a8[ g]
    fis[ g] a4 b2 %25
    a a\fermata
    \tempoF-IIIFacUt g4.\fE g8 es'4. es8
    d4. h8 c[ g] c4~
    c8[ b] a4 g8 a b a
...
F-IIIPlagisSopranoLyrics = \lyricmode {
  Fac me pla -- gis
  vul -- ne -- ra --
  ri, vul -- ne -- ra --
  ri, vul -- ne -- ra --
