...
F-IIIStabatBassoLyrics = \lyricmode {
  Sta -- bat ma -- %8
  ter do -- lo --
  ro -- _ %10
  _ _ _
...
F-IIIOQuamBassoLyrics = \lyricmode {
  O quam
  tri -- stis
  et af --
  fli -- cta
...
F-IIISanctaBassoLyrics = \lyricmode {
  San -- cta
  ma -- ter,
  i -- stud a --
  gas, cru -- ci --
...
F-IIIPlagisBasso = {
  \relative c {
    ...
    g,4 g \tempoF-IIIMorietur r2
    R1
    r4 g8\p g es'2
    d1~ %25
    d2 d\fermata
    \tempoF-IIIFacUt R1*7 %33
    d4.\fE d8 b'4. b8
    a4. fis8 g[ d] g4~ %35
    g8[ f] e4 d r
    r2 r4  g8 g
...
F-IIIPlagisBassoLyrics = \lyricmode {
  Fac me pla -- gis
  vul -- ne --
  ra -- ri, vul -- ne --
  ra -- ri, vul -- ne --
