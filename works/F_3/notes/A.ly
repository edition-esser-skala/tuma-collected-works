...
F-IIIOQuamAltoLyrics = \lyricmode {
  O quam
  tri -- stis
  et af --
  fli -- cta
...
F-IIIQuisEstAlto = {
  \relative c' {
    ...
    g( fis8.) fis16 g4 \tempoF-IIIProPeccatis r
    R1*11
    \tempoF-IIIEiaMater r4 c,8 c d es f es16([ d)]
    es([ d)] c8 r4 r2
    r4 g'8 g g f f f
    f4( es) d r
...
F-IIIQuisEstAltoLyrics = \lyricmode {
  Quis est ho -- mo,
  ma -- trem Chri -- sti
...
F-IIISanctaAltoLyrics = \lyricmode {
  San -- cta
  ma -- ter, i --
  stud a --
  gas, cru -- ci -- fi --
...
F-IIIFacTecumAltoLyrics = \lyricmode {
  Fac me %15
  te -- cum
  pi -- e __
  fle -- re,
...
F-IIIPlagisAltoLyrics = \lyricmode {
  Fac me pla -- gis
  vul -- ne --
  ra -- ri, vul -- ne --
  ra -- ri, vul -- ne --
