...
C-II-VIISoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \autoBeamOff \tempoC-II-VIIPlacare
    R1*9 %9
    ...
    d8) h es4 d r8 c\f
    d c4( h8) c4 r
    \tempoC-II-VIIAmenB as2 g\fermata \bar "|." %130 finis
  }
}

C-II-VIISopranoLyrics = \lyricmode {
  Pla -- %10
  ca -- re, Chri --
  ste, ser -- vu --
  lis, pla -- ca -- re
