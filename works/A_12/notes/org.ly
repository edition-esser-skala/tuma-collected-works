...
A-XIIGloriaOrgano = {
  \relative c {
    ...
    e c g2 \noBreak
    c4 r r2\fermata \bar "||"
    \tempoA-XIIQuiTollis r4 \mvTr e2\fE-\tutti dis4 \noBreak
    e d c2 %10
    h r
    r4 e d!2
    c f4 d
    ...
    h1 \noBreak
    e,\fermata \bar "||" %25
    \tempoA-XIIQuoniam \mvTr g'4\pE-\solo g8 fis e d c d \noBreak
    g4 fis g8 c, d4
    g,4. \mvTr g8\fE-\tutti d'4 dis
    e4. a,8 h2 \noBreak
    e,4 r r2\fermata \bar "||" %30
    \clef treble \twotwotime \time 2/2 \tempoA-XIIAmen \newSpacingSection
    << {
      h'''1
      e,2 e'
      d c4 h
...
A-XIICredoOrgano = {
  \relative c {
    ...
    \tempoA-XIIEtIncarnatus \mvTr e'2\fE-\tutti a,4 e' \noBreak %10
    ...
    \twotwotime \clef treble \time 2/2 \tempoA-XIIAmenCredo \newSpacingSection
      h'''2 h \noBreak
    h4 c h a %45
    << {
      g e h' cis
...
A-XIIBenedictusOrgano = {
  \relative c {
    ...
    a h1 \noBreak
    e,1.\fermata \bar "||"
    \clef treble \time 4/4 \tempoA-XIIOsanna \newSpacingSection
...
A-XIIAgnusOrgano = {
  \relative c {
    ...
    h \noBreak %35
    e,\fermata \bar "||"
    \clef treble \twotwotime \time 2/2 \tempoA-XIIDona \newSpacingSection
      h'''2. h4 \noBreak
    e2 h
    c4 h c a
    << {
