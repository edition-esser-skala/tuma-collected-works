...
D-III-VIMiserereTenoreLyrics = \lyricmode {
  Mi -- se -- re -- re,
...
D-III-VITibiSoliTenore = {
  \relative c' {
    ...
    es( d8[ c)] d2~ \noBreak
    d r\fermata
    \tempoD-III-VIUtIustificeris es8 c h d es c4 b?8~ \noBreak
...
D-III-VITibiSoliTenoreLyrics = \lyricmode {
  Pec -- ca -- %2
  _
  vi, pec -- ca -- _
  _ _ _ %5
...
D-III-VIEcceEnimTenore = {
  \relative c' {
    \clef "treble_8"
    \key g \minor \time 3/4 \autoBeamOff \tempoD-III-VIEcceEnim
    b4\fE a r
    r d d
    d d d
    c c c
...
D-III-VIEcceEnimTenoreLyrics = \lyricmode {
  Ec -- ce,
  ec -- ce
  e -- nim in
  in -- i -- qui --
...
D-III-VIAspergesTenoreLyrics = \lyricmode {
  A --
  sper --
  ges me __
  hys -- so -- po,
...
D-III-VIAudituiTenoreLyrics = \lyricmode {
  Au --
  di -- tu -- i
  me -- o
  da --
...
D-III-VIAverteTenore = {
  \relative c' {
    \clef "treble_8"
    \key g \minor \time 4/4 \autoBeamOff \tempoD-III-VIAverte
...
D-III-VIAverteTenoreLyrics = \lyricmode {
  A -- ver -- te, a -- ver -- te, a --
...
D-III-VINeProiciasTenoreLyrics = \lyricmode {
  Ne pro -- %9
  i -- ci -- as, %10
  ne pro --
  i -- ci -- as
...
D-III-VIDomineTenoreLyrics = \lyricmode {
  Do -- _ %3
  _ _ _ mi --
  ne, %5
...
D-III-VIQuoniamTenoreLyrics = \lyricmode {
  Quo -- ni -- am
  si vo -- lu --
  is -- ses
  sa -- cri --
...
D-III-VISacrificiumTenoreLyrics = \lyricmode {
  Sa -- %2
  cri -- fi -- ci -- um
  De -- o, sa --
  cri -- fi -- ci -- um %5
...
D-III-VIBenigneTenoreLyrics = \lyricmode {
  Be -- ni -- gne, be --
...
D-III-VIGloriaTenore = {
  \relative c' {
    ...
    \tempoD-III-VIEtInSaecula c4 c es d8 c \noBreak
    d c h4 c r8 b
    c4 b8 es c8. c16 d4
    es f!8. f16 c4 as
    f g es4. es'8 %15
...
D-III-VIGloriaTenoreLyrics = \lyricmode {
  Glo -- _ ri -- a,
  glo -- ri -- a Pa -- tri,
  glo -- _ ri -- a,
  glo -- ri -- a Fi -- li -- o,
