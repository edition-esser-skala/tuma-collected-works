...
D-III-VIMiserereSopranoLyrics = \lyricmode {
  Mi -- se -- re -- re,
  mi -- se --
  re -- re, mi -- se --
  re -- re, mi --
...
D-III-VITibiSoliSoprano = {
  \relative c' {
    ...
    es c r4 r \tempoD-III-VICumIudicaris c
    h c c( h)
    c2 r\fermata \bar "||" %24 finis
  }
}

D-III-VITibiSoliSopranoLyrics = \lyricmode {
  Ti -- bi so -- li, __
  so -- li pec -- ca --
  _ _
  _ _
...
D-III-VIEcceEnimSopranoLyrics = \lyricmode {
  Ec -- ce,
  ec -- ce
  e -- nim in
  in -- i -- qui --
...
D-III-VIAspergesSopranoLyrics = \lyricmode {
  A -- %9
  sper -- %10
  ges me hys --
  so -- po, et __ mun --
...
D-III-VIAudituiSopranoLyrics = \lyricmode {
  Au --
  di -- tu -- i
  me -- o
  da -- bis gau --
...
D-III-VIAverteSopranoLyrics = \lyricmode {
  A -- ver -- te, a --
...
D-III-VINeProiciasSopranoLyrics = \lyricmode {
  Red -- de %30
  mi -- hi,
  red -- de
  mi -- hi, red -- de
...
D-III-VIDomineSopranoLyrics = \lyricmode {
  Do -- _
  _ _ _ mi --
  ne,
...
D-III-VIQuoniamSopranoLyrics = \lyricmode {
  Quo -- ni -- am
  si vo -- lu --
  is -- ses
  sa -- cri --
...
D-III-VISacrificiumSopranoLyrics = \lyricmode {
  Sa -- cri -- fi -- ci -- um %5
  De --
  o spi -- ri -- tus
  con -- tri -- bu -- la -- _
...
D-III-VIBenigneSopranoLyrics = \lyricmode {
  Be --
...
D-III-VIGloriaSopranoLyrics = \lyricmode {
  Glo --
  _ ri -- a Pa -- tri,
  glo --
  _ ri -- a Fi -- li -- o,
