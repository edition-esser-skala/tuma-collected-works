...
D-III-VIMiserereOrgano = {
  \relative c {
    \clef bass
    \key c \dorian \time 4/4 \tempoD-III-VIMiserere
    c2\fE h
    R1
    c2 b!
    as r
...
D-III-VIAmpliusBassFigures = \figuremode {
  r2.
  <6>2 <_+>4
  <6>2.
  <6->2 <[5!] _+>4
...
D-III-VITibiSoliBassFigures = \figuremode {
  r1
  r2 <4! 2>
  <\t _+> <7 5! _+>4 <6 4>
  <5- 4> <\t _!> <10 9> <\t 8>
...
D-III-VIEcceEnimOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 3/4 \tempoD-III-VIEcceEnim
    g'4\fE fis r
    r g d
    b g b
    c es f!
...
D-III-VIEcceEnimBassFigures = \figuremode {
  r4 <6>2
  r <_+>4
  <6>2 q4
  r q2
...
D-III-VIAspergesBassFigures = \figuremode {
  r\breve
  r
  r
  r
...
D-III-VIAudituiOrgano = {
  \relative c {
    \clef bass
    \key es \major \time 3/4 \tempoD-III-VIAuditui
    es4\fE r es
    es2 c4
    b2 g'4
    as2 as,4
...
D-III-VIAudituiBassFigures = \figuremode {
  r2.
  r2 <5>8 <6!>
  r2 <6>4
  <9> <8>2
...
D-III-VIAverteOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 4/4 \tempoD-III-VIAverte
...
D-III-VINeProiciasBassFigures = \figuremode {
  r2.
  r
  r
  r
...
D-III-VIQuoniamBassFigures = \figuremode {
  r2.
  <6 _->4 <6 4> <5 _!>
  <6>2.
  r4 <6->2
