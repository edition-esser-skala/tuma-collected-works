...
PrimaOrgano = {
  \relative c {
    \clef "treble_8"
    \key g \dorian \time 2/1 \tempoH-IPrima
...
SecundaOrgano = {
  \relative c {
    \clef bass
    \key f \major \time 2/1 \tempoH-ISecunda
      \set Staff.timeSignatureFraction = 2/2
    f\breve
    c
    g'
...
TertiaOrgano = {
  \relative c {
    \clef bass
    \key f \major \time 2/1 \tempoH-ITertia
      \set Staff.timeSignatureFraction = 2/2
    a'\breve
    g1 f~
    f g
